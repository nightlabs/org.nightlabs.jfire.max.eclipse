...
extends XComposite
{
	...
	protected void createComposite(Composite parent) {
		...
		autoCreateIDCheckBox.setText(Messages.getString("org.nightlabs.jfire.issuetracking.admin.ui.overview.issueproperty.IssueTypeSeverityTypeComposite.button.autoCreateID.text")); //$NON-NLS-1$

		idLabel = new Label(idGroup, SWT.NONE);
		idLabel.setText(Messages.getString("org.nightlabs.jfire.issuetracking.admin.ui.overview.issueproperty.IssueTypeSeverityTypeComposite.label.id.text")); //$NON-NLS-1$
