...
public class CreateProjectTypeNameWizardPage extends DynamicPathWizardPage
{
	...
	public Control createPageContents(Composite parent) {
		...
		new Label(page, SWT.NONE).setText(Messages.getString("org.nightlabs.jfire.issuetracking.ui.projecttype.CreateProjectTypeNameWizardPage.label.projectName.text")); //$NON-NLS-1$
	...
	{
		super(CreateProjectTypeNameWizardPage.class.getName(), Messages.getString("org.nightlabs.jfire.issuetracking.ui.projecttype.CreateProjectTypeNameWizardPage.title"),  //$NON-NLS-1$
				SharedImages.getWizardPageImageDescriptor(IssueTrackingPlugin.getDefault(), CreateProjectTypeNameWizardPage.class));
		this.setDescription(Messages.getString("org.nightlabs.jfire.issuetracking.ui.projecttype.CreateProjectTypeNameWizardPage.description")); //$NON-NLS-1$
