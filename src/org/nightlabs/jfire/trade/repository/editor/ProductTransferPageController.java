...
extends EntityEditorPageController
{
	...
	{
		monitor.beginTask(Messages.getString("org.nightlabs.jfire.trade.repository.editor.ProductTransferPageController.loadingProductTransfersJobMonitor.task.name"), 100); //$NON-NLS-1$
	...
	public void fireProductTransferQueryChange()
	{
		...
		Job job = new Job(Messages.getString("org.nightlabs.jfire.trade.repository.editor.ProductTransferPageController.loadingProductTransfersJob.name")) { //$NON-NLS-1$
			@Override
