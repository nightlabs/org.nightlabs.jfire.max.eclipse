...
implements IPropertySource
{
	...
	public static final String CATEGORY_NAME = Messages.getString("org.nightlabs.jfire.reporting.admin.parameter.ui.property.AbstractPropertySource.propertyDescriptorCategoryName.name"); //$NON-NLS-1$
	public static final String CATEGORY_PARAMETER = Messages.getString("org.nightlabs.jfire.reporting.admin.parameter.ui.property.AbstractPropertySource.propertyDescriptorCategoryParameter.name"); //$NON-NLS-1$
	...
	protected PropertyDescriptor createXPD(boolean readOnly)
	{
		PropertyDescriptor desc = new IntPropertyDescriptor(
				...
				Messages.getString("org.nightlabs.jfire.reporting.admin.parameter.ui.property.AbstractPropertySource.propertyDescriptorX.name"), //$NON-NLS-1$
				readOnly);
	...
	protected PropertyDescriptor createYPD(boolean readOnly)
	{
		PropertyDescriptor desc = new IntPropertyDescriptor(
				...
				Messages.getString("org.nightlabs.jfire.reporting.admin.parameter.ui.property.AbstractPropertySource.propertyDescriptorY.name"), //$NON-NLS-1$
				readOnly);
		desc.setCategory(CATEGORY_GEOM);
		return desc;
	}
	...
	protected PropertyDescriptor createConsumerKeyPD(boolean readOnly)
	{
		PropertyDescriptor desc = new XTextPropertyDescriptor(
				...
				Messages.getString("org.nightlabs.jfire.reporting.admin.parameter.ui.property.AbstractPropertySource.propertyDescriptorConsumerKey.name"), //$NON-NLS-1$
				readOnly);
