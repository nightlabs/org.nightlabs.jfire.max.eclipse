...
public class JFSQueryPropertySetTable extends AbstractTableComposite {
	...
	public static class LabelProvider implements ITableLabelProvider {
		...
		public String getColumnText(Object element, int colIdx) {
			if (element instanceof Map.Entry) {
				...
				if (colIdx == 0)
					return Messages.getString("org.nightlabs.jfire.reporting.admin.oda.jfs.client.ui.JFSQueryPropertySetTable.addKeyColumnText"); //$NON-NLS-1$
			}
			return ""; //$NON-NLS-1$
		}
	...
	private class CellModifier implements ICellModifier {
		...
		public Object getValue(Object element, String property) {
			...
			return Messages.getString("org.nightlabs.jfire.reporting.admin.oda.jfs.client.ui.JFSQueryPropertySetTable.newPropertyNameLabel"); //$NON-NLS-1$
		}
	...
	protected void createTableColumns(TableViewer tableViewer, Table table) {
		...
		col1.setText(Messages.getString("org.nightlabs.jfire.reporting.admin.oda.jfs.client.ui.JFSQueryPropertySetTable.keyColumn.text")); //$NON-NLS-1$
		
		TableColumn col2 = new TableColumn(table, SWT.LEFT);
		col2.setText(Messages.getString("org.nightlabs.jfire.reporting.admin.oda.jfs.client.ui.JFSQueryPropertySetTable.valueColumn.text")); //$NON-NLS-1$
