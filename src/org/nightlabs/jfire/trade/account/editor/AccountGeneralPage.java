...
public class AccountGeneralPage extends EntityEditorPageWithProgress
{
	...
	public AccountGeneralPage(FormEditor editor) {
		super(editor, ID_PAGE, Messages.getString("org.nightlabs.jfire.trade.account.editor.AccountGeneralPage.title")); //$NON-NLS-1$
	}
...
//				switchToContent();
	...
	protected String getPageFormTitle() {
		return Messages.getString("org.nightlabs.jfire.trade.account.editor.AccountGeneralPage.pageFormTitle"); //$NON-NLS-1$
	}
}