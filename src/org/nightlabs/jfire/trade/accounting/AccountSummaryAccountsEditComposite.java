...
//		super(parent, style, true);
		...
		label.setText(Messages.getString("org.nightlabs.jfire.trade.accounting.AccountSummaryAccountsEditComposite.descriptionLabel.text")); //$NON-NLS-1$
		...
		if (showButtons) {
			...
			addButton.setText(Messages.getString("org.nightlabs.jfire.trade.accounting.AccountSummaryAccountsEditComposite.addButton.text")); //$NON-NLS-1$
			addButton.setLayoutData(new GridData(GridData.FILL_HORIZONTAL));
			addButton.addSelectionListener(addButtonListener);
			
			removeButton = new Button(buttonWrapper, SWT.PUSH);
			removeButton.setText(Messages.getString("org.nightlabs.jfire.trade.accounting.AccountSummaryAccountsEditComposite.removeButton.text")); //$NON-NLS-1$
