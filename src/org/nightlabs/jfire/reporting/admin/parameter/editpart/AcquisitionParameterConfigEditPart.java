package org.nightlabs.jfire.reporting.admin.parameter.editpart;
...
import org.nightlabs.jfire.reporting.admin.parameter.editpolicy.AcquisitionParameterConfigEditPolicy;
import org.nightlabs.jfire.reporting.admin.parameter.figure.AcquistionParameterConfigFigure;
...
//			"ConsumerKey " + getAcquisitionParameterConfig().getConsumerKey();
		return Messages.getString("org.nightlabs.jfire.reporting.admin.parameter.editpart.AcquisitionParameterConfigEditPart.figureText.prefix") + getAcquisitionParameterConfig().getParameterID(); //$NON-NLS-1$
	}
