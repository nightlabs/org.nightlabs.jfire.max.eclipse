package org.nightlabs.jfire.simpletrade.admin.ui.tariffuserset;
...
extends AbstractTariffUserSetPage 
{
	/**
	...
	public static class Factory implements IEntityEditorPageFactory {
		...
		public IEntityEditorPageController createPageController(EntityEditor editor) {
			return new TariffUserSetPageController<SimpleProductType>(editor, SimpleProductTypeDAO.sharedInstance());
		}
	}
