 ...
 *
 */
public class ScriptConditionerContext 
{
	public ScriptConditionerContext(String organisationID, String conditionContextProviderID) {
	...
	public void setConditionContextProviderID(String conditionContextProviderID) {
		this.conditionContextProviderID = conditionContextProviderID;
	}
