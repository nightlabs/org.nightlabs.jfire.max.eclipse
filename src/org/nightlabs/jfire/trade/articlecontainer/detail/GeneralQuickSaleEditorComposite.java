...
import org.nightlabs.jfire.trade.legalentity.view.SelectAnonymousViewAction;
...
extends XComposite
{
	...
	protected void createComposite(Composite parent, GeneralEditorInput input) 
	{
		...
		deleteButton.setText(Messages.getString("org.nightlabs.jfire.trade.articlecontainer.detail.GeneralQuickSaleEditorComposite.deleteButton.text")); //$NON-NLS-1$
		...
		customerSearchLabel.setText(Messages.getString("org.nightlabs.jfire.trade.articlecontainer.detail.GeneralQuickSaleEditorComposite.customerSearchLabel.text")); //$NON-NLS-1$
		...
		okButtonCustomer.setText(Messages.getString("org.nightlabs.jfire.trade.articlecontainer.detail.GeneralQuickSaleEditorComposite.okButtonCustomer.text")); //$NON-NLS-1$
...
//		Label separator = new Label(buttonComp, SWT.SEPARATOR);
		...
		okButtonAnonymous.setText(Messages.getString("org.nightlabs.jfire.trade.articlecontainer.detail.GeneralQuickSaleEditorComposite.okButtonAnonymous.text")); //$NON-NLS-1$
