...
extends AbstractArticleContainerListComposite
{
			...
			TableViewer tableViewer, Table table, TableLayout tableLayout)
	{
		...
		tc.setText(Messages.getString("org.nightlabs.jfire.trade.overview.deliverynote.DeliveryNoteListComposite.deliveryNoteIDPrefixTableColumn.text")); //$NON-NLS-1$
			...
			Table table, TableLayout tableLayout)
	{
		...
		tc.setText(Messages.getString("org.nightlabs.jfire.trade.overview.deliverynote.DeliveryNoteListComposite.deliveryNoteIDTableColumn.text")); //$NON-NLS-1$
		tableLayout.addColumnData(new ColumnWeightData(10));
	}
	...
	{
		TableColumn tc = new TableColumn(table, SWT.LEFT);
		tc.setText(Messages.getString("org.nightlabs.jfire.trade.overview.deliverynote.DeliveryNoteListComposite.finalizeDateTableColumn.text")); //$NON-NLS-1$
		tableLayout.addColumnData(new ColumnWeightData(10));

		tc = new TableColumn(table, SWT.LEFT);
		tc.setText(Messages.getString("org.nightlabs.jfire.trade.overview.deliverynote.DeliveryNoteListComposite.finalizeUserTableColumn.text")); //$NON-NLS-1$
		tableLayout.addColumnData(new ColumnWeightData(10));
	}
