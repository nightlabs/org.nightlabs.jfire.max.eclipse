...
package org.nightlabs.jfire.simpletrade.producttype.quicklist;
...
//extends AbstractProductTypeViewerQuickListFilter
{
	...
	public String getDisplayName() {
		return Messages.getString("org.nightlabs.jfire.simpletrade.producttype.quicklist.SimpleProductTypeQuickListFilter.displayName"); //$NON-NLS-1$
	}
	...
	public void search(ProgressMonitor monitor) { 
		...
		new Job(Messages.getString("org.nightlabs.jfire.simpletrade.producttype.quicklist.SimpleProductTypeQuickListFilter.searchProductTypesJob.name")) { //$NON-NLS-1$
			@Override
