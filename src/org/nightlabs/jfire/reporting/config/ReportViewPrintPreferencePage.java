...
extends LSDPreferencePage
{
	...
	public void createPartContents(Composite parent) {
		...
		descriptionLabel.setText(Messages.getString("org.nightlabs.jfire.reporting.config.ReportViewPrintPreferencePage.descriptionLabel.text")); //$NON-NLS-1$
		...
		sameForAll.setText(Messages.getString("org.nightlabs.jfire.reporting.config.ReportViewPrintPreferencePage.sameForAllButton.text")); //$NON-NLS-1$
...
//		return wrapper;
	...
	public boolean performOk() {
		...
		try {
			...
			MessageDialog dlg = new MessageDialog(RCPUtil.getActiveWorkbenchShell(), Messages.getString("org.nightlabs.jfire.reporting.config.ReportViewPrintPreferencePage.savingFailedMessage"), null, e.getMessage(), 0, new String[]{Messages.getString("org.nightlabs.jfire.reporting.config.ReportViewPrintPreferencePage.okButton.text")}, 0); //$NON-NLS-1$ //$NON-NLS-2$
			dlg.open();
		}
