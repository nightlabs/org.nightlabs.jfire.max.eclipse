...
extends XComposite
{
	...
	protected void createComposite(Composite parent) 
	{
		...
		searchLabel.setText(Messages.getString("org.nightlabs.jfire.trade.store.search.AbstractProductTypeSearchComposite.searchLabel.text")); //$NON-NLS-1$
		...
		expandableComposite.setText(Messages.getString("org.nightlabs.jfire.trade.store.search.AbstractProductTypeSearchComposite.expandableComposite.text")); //$NON-NLS-1$
	...
	public void searchPressed() 
	{
		...
		Job searchJob = new Job(Messages.getString("org.nightlabs.jfire.trade.store.search.AbstractProductTypeSearchComposite.searchJob.name")) { //$NON-NLS-1$
			@Override
			protected IStatus run(IProgressMonitor monitor) {
				Display.getDefault().syncExec(new Runnable() {
					public void run() {
						productTypeTableComposite.setInput(new String[] {Messages.getString("org.nightlabs.jfire.trade.store.search.AbstractProductTypeSearchComposite.productTypeTableComposite.input_searching")}); //$NON-NLS-1$
					}
				});
