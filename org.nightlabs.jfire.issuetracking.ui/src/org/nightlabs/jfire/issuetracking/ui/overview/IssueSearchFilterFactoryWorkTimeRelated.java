...
/**
 * 
 * @author Chairat Kongarayawetchakun - chairatk[at]nightlabs[dot]com
 */
public class IssueSearchFilterFactoryWorkTimeRelated
extends AbstractQueryFilterFactory<IssueQuery>
{
	...
	{
		return new IssueFilterCompositeWorkTimeRelated(parent, style, layoutMode, layoutDataMode, queryProvider);
	}
}
