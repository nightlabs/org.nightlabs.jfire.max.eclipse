...
extends LSDViewPart
{
	...
	public void createPartContents(Composite parent)
	{
		...
		createTariffMappingButton.setText(Messages.getString("org.nightlabs.jfire.trade.admin.tariffmapping.TariffMappingView.createTariffMappingButton.text")); //$NON-NLS-1$
		...
		removeTariffMappingButton.setText(Messages.getString("org.nightlabs.jfire.trade.admin.tariffmapping.TariffMappingView.removeTariffMappingButton.text")); //$NON-NLS-1$
