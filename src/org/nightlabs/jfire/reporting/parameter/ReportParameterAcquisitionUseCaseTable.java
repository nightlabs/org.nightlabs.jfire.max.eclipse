...
public class ReportParameterAcquisitionUseCaseTable extends AbstractTableComposite<ReportParameterAcquisitionUseCase> {
	...
	protected void createTableColumns(TableViewer tableViewer, Table table) {
		...
		col.setText(Messages.getString("org.nightlabs.jfire.reporting.parameter.ReportParameterAcquisitionUseCaseTable.useCaseColumn.text")); //$NON-NLS-1$
		col.setToolTipText(Messages.getString("org.nightlabs.jfire.reporting.parameter.ReportParameterAcquisitionUseCaseTable.useCaseColumn.toolTipText")); //$NON-NLS-1$
//		col.setL
