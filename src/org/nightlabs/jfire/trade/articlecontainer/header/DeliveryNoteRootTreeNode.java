...
public class DeliveryNoteRootTreeNode extends ArticleContainerRootTreeNode
{
	...
	{
		super(headerTreeNode, Messages.getString("org.nightlabs.jfire.trade.articlecontainer.header.DeliveryNoteRootTreeNode.name"), headerTreeNode.getHeaderTreeComposite().imageDeliveryNoteRootTreeNode, customerSide); //$NON-NLS-1$
		init();
	}
