...
import org.nightlabs.jfire.trade.transfer.wizard.DeliveryQueueDeliveryWizard;
...
class DeliveryQueueBrowsingComposite extends FadeableComposite {
	...
	void refreshDeliveryQueues() {
		...
		setFaded(true);
		refreshing = true;
		Job refreshJob = new Job(Messages.getString("org.nightlabs.jfire.trade.transfer.deliver.DeliveryQueueBrowsingComposite.refreshDeliveryQueuesJob.name")) { //$NON-NLS-1$
			@Override
