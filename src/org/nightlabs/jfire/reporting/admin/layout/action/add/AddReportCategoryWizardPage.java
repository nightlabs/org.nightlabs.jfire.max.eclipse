...
public class AddReportCategoryWizardPage extends I18nTextEditorWizardPage {
	...
	public AddReportCategoryWizardPage() {
		super(AddReportCategoryWizardPage.class.getName(), Messages.getString("org.nightlabs.jfire.reporting.admin.layout.action.add.AddReportCategoryWizardPage.title"), Messages.getString("org.nightlabs.jfire.reporting.admin.layout.action.add.AddReportCategoryWizardPage.editorCaption")); //$NON-NLS-1$ //$NON-NLS-2$
	}
