...
package org.nightlabs.jfire.trade.articlecontainer.detail.action.reverse;
...
public class SelectOfferPage extends DynamicPathWizardPage
{
	...
	{
		super(SelectOfferPage.class.getName(), Messages.getString("org.nightlabs.jfire.trade.articlecontainer.detail.action.reverse.SelectOfferPage.title")); //$NON-NLS-1$
		setDescription(Messages.getString("org.nightlabs.jfire.trade.articlecontainer.detail.action.reverse.SelectOfferPage.description")); //$NON-NLS-1$
	}
	...
	public Control createPageContents(Composite parent)
	{
		...
		createOfferRadio.setText(Messages.getString("org.nightlabs.jfire.trade.articlecontainer.detail.action.reverse.SelectOfferPage.createOfferRadio.text")); //$NON-NLS-1$
		createOfferRadio.setSelection(true);
		selectOfferRadio = new Button(page, SWT.RADIO);
		selectOfferRadio.setText(Messages.getString("org.nightlabs.jfire.trade.articlecontainer.detail.action.reverse.SelectOfferPage.selectOfferRadio.text")); //$NON-NLS-1$
		...
		offerTable = new AbstractTableComposite(page, SWT.NONE, true, SWT.BORDER | SWT.FULL_SELECTION | SWT.SINGLE) {
			...
			{
				new TableColumn(table, SWT.RIGHT).setText(Messages.getString("org.nightlabs.jfire.trade.articlecontainer.detail.action.reverse.SelectOfferPage.offerIDTableColumn.text")); //$NON-NLS-1$
				new TableColumn(table, SWT.LEFT).setText(Messages.getString("org.nightlabs.jfire.trade.articlecontainer.detail.action.reverse.SelectOfferPage.createDateTableColumn.text")); //$NON-NLS-1$
				new TableColumn(table, SWT.LEFT).setText(Messages.getString("org.nightlabs.jfire.trade.articlecontainer.detail.action.reverse.SelectOfferPage.createUserTableColumn.text")); //$NON-NLS-1$
		...
		offers.add(Messages.getString("org.nightlabs.jfire.trade.articlecontainer.detail.action.reverse.SelectOfferPage.loadOffersPseudoEntry")); //$NON-NLS-1$
		offerTable.setInput(offers);
		offerTable.setEnabled(selectOfferRadio.getSelection());

		new Job(Messages.getString("org.nightlabs.jfire.trade.articlecontainer.detail.action.reverse.SelectOfferPage.loadOffersJob.name")) { //$NON-NLS-1$
