 ...
 *
 */
public class LegalEntityEditorPhoneNumberDataFieldEditorFactory
extends AbstractDataFieldEditorFactory<PhoneNumberDataField>
{
	/* (non-Javadoc)
	...
	public DataFieldEditor<PhoneNumberDataField> createPropDataFieldEditor(IStruct struct, PhoneNumberDataField data) {
		return new LegalEntityEditorPhoneNumberDataFieldEditor(struct, data);
	}
