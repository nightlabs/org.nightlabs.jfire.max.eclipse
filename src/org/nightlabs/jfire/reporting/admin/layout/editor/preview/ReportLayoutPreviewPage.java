...
package org.nightlabs.jfire.reporting.admin.layout.editor.preview;
...
import org.nightlabs.jfire.reporting.admin.ReportingAdminPlugin;
import org.nightlabs.jfire.reporting.admin.layout.editor.IJFireRemoteReportEditorInput;
import org.nightlabs.jfire.reporting.admin.layout.editor.JFireRemoteReportEditorInput;
import org.nightlabs.jfire.reporting.admin.layout.editor.JFireReportEditor;
import org.nightlabs.jfire.reporting.admin.layout.editor.l10n.IReportLayoutL10nManager;
...
implements IReportEditorPage
{
	...
	/*
	 * (non-Javadoc)
	 * @see org.nightlabs.jfire.reporting.admin.layout.editor.preview.ReportLayoutPreviewEditor#createPartControl(org.eclipse.swt.widgets.Composite)
	 */
	@Override
	public void createPartControl(Composite parent) {
		...
		parameterButton.setText(Messages.getString("org.nightlabs.jfire.reporting.admin.layout.editor.preview.ReportLayoutPreviewPage.parameterButton.text")); //$NON-NLS-1$
		...
		label.setText(Messages.getString("org.nightlabs.jfire.reporting.admin.layout.editor.preview.ReportLayoutPreviewPage.outputTypeLabel.text")); //$NON-NLS-1$
		...
		label2.setText(Messages.getString("org.nightlabs.jfire.reporting.admin.layout.editor.preview.ReportLayoutPreviewPage.localeLabel.text")); //$NON-NLS-1$
...
//		viewerWrapper = new XComposite(wrapper, SWT.NONE, LayoutMode.TIGHT_WRAPPER);
	 ...
	 * 
	 * @see org.nightlabs.jfire.reporting.admin.layout.editor.preview.ReportLayoutPreviewEditor#getProvider()
	 */
