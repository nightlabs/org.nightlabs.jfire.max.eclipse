		...
		extends TransferTreeNode
{
	...
	public String getColumnText(int columnIndex)
	{
		switch (columnIndex) {
			case 0:
				return Messages.getString("org.nightlabs.jfire.trade.transfer.error.PaymentTreeNode.payment"); //$NON-NLS-1$
			case 1:
				return NumberFormatter.formatCurrency(payment.getAmount(), payment.getCurrency());
			case 2:
				return payment.isFailed() ? Messages.getString("org.nightlabs.jfire.trade.transfer.error.PaymentTreeNode.failure") : Messages.getString("org.nightlabs.jfire.trade.transfer.error.PaymentTreeNode.success"); //$NON-NLS-1$ //$NON-NLS-2$
			case 3:
				return payment.isRolledBack() ? Messages.getString("org.nightlabs.jfire.trade.transfer.error.PaymentTreeNode.rolledBack") : Messages.getString("org.nightlabs.jfire.trade.transfer.error.PaymentTreeNode.notRolledBack"); //$NON-NLS-1$ //$NON-NLS-2$
			default:
				return ""; //$NON-NLS-1$
		}
	}
