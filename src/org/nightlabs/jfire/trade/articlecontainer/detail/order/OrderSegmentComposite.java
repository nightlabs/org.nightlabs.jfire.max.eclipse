...
public class OrderSegmentComposite extends XComposite
{
	...
	public OrderSegmentComposite(Composite parent, OrderSegmentEdit _orderSegmentEdit)
	{
		...
		articleAdderPlaceholderLabel.setText(Messages.getString("org.nightlabs.jfire.trade.articlecontainer.detail.order.OrderSegmentComposite.articleAdderPlaceholderLabel.text")); //$NON-NLS-1$
