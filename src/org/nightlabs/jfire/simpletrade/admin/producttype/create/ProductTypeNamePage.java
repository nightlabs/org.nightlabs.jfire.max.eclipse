...
//	private Button createPriceConfigCheckBox;
	...
	{
		super(ProductTypeNamePage.class.getName(), Messages.getString("org.nightlabs.jfire.simpletrade.admin.producttype.create.ProductTypeNamePage.title")); //$NON-NLS-1$
		this.setDescription(Messages.getString("org.nightlabs.jfire.simpletrade.admin.producttype.create.ProductTypeNamePage.description")); //$NON-NLS-1$
//		this.parentProductType = parentProductType;
	...
	public Control createPageContents(Composite parent)
	{
		...
		inheritanceNatureCombo.add( Messages.getString("org.nightlabs.jfire.simpletrade.admin.producttype.create.ProductTypeNamePage.inheritanceNatureCombo.item_node")); //$NON-NLS-1$
		inheritanceNatureCombo.add(Messages.getString("org.nightlabs.jfire.simpletrade.admin.producttype.create.ProductTypeNamePage.inheritanceNatureCombo.item_leaf")); //$NON-NLS-1$
		...
		packageNatureCombo.add(Messages.getString("org.nightlabs.jfire.simpletrade.admin.producttype.create.ProductTypeNamePage.packageNatureCombo.item_inner")); //$NON-NLS-1$
		packageNatureCombo.add(Messages.getString("org.nightlabs.jfire.simpletrade.admin.producttype.create.ProductTypeNamePage.packageNatureCombo.item_outer")); //$NON-NLS-1$
		...
		new Label(page, SWT.NONE).setText(Messages.getString("org.nightlabs.jfire.simpletrade.admin.producttype.create.ProductTypeNamePage.nameLabel.text")); //$NON-NLS-1$
		...
		page.setFaded(true);
		packageNatureDescription.setText(Messages.getString("org.nightlabs.jfire.simpletrade.admin.producttype.create.ProductTypeNamePage.packageNatureDescription.text_loading")); //$NON-NLS-1$

		Job job = new Job(Messages.getString("org.nightlabs.jfire.simpletrade.admin.producttype.create.ProductTypeNamePage.loadProductTypeJob.name")) { //$NON-NLS-1$
			@Implement
...
//	}
	...
	private void setPackageNatureDescription() 
	{
		if (packageNatureCombo.getSelectionIndex() == 0)
			packageNatureDescription.setText(Messages.getString("org.nightlabs.jfire.simpletrade.admin.producttype.create.ProductTypeNamePage.packageNatureDescription.text_inner")); //$NON-NLS-1$
		if (packageNatureCombo.getSelectionIndex() == 1)		
			packageNatureDescription.setText(Messages.getString("org.nightlabs.jfire.simpletrade.admin.producttype.create.ProductTypeNamePage.packageNatureDescription.text_outer")); //$NON-NLS-1$
