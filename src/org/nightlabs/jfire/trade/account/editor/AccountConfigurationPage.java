...
extends EntityEditorPageWithProgress 
{
	...
	public AccountConfigurationPage(FormEditor editor) {
		super(editor, ID_PAGE, Messages.getString("org.nightlabs.jfire.trade.account.editor.AccountConfigurationPage.title")); //$NON-NLS-1$
	}
...
//		Display.getDefault().syncExec(new Runnable() {
	...
	protected String getPageFormTitle() {
		return Messages.getString("org.nightlabs.jfire.trade.account.editor.AccountConfigurationPage.title"); //$NON-NLS-1$
	}
}
