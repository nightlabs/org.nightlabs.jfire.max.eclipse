...
public class JFireReportingExpressionProvider implements IExpressionProvider {
	...
	private synchronized static void createIndex() {
		...
		identifier2Name.put(CATEGORY_IMPORTS.getItemKey(), Messages.getString("org.nightlabs.jfire.reporting.admin.oda.jfs.client.ui.JFireReportingExpressionProvider.identifier.import")); //$NON-NLS-1$
		identifier2Name.put(CATEGORY_IMPORTS_HELPER.getItemKey(), Messages.getString("org.nightlabs.jfire.reporting.admin.oda.jfs.client.ui.JFireReportingExpressionProvider.identifier.reportingHelper")); //$NON-NLS-1$
		identifier2Name.put(CATEGORY_HELPER_METHODS.getItemKey(), Messages.getString("org.nightlabs.jfire.reporting.admin.oda.jfs.client.ui.JFireReportingExpressionProvider.identifier.helperMethods")); //$NON-NLS-1$
		identifier2Name.put(CATEGORY_HELPER_METHODS_DATASET_PARAM.getItemKey(), Messages.getString("org.nightlabs.jfire.reporting.admin.oda.jfs.client.ui.JFireReportingExpressionProvider.identifier.createDatasetParameters")); //$NON-NLS-1$
		identifier2Name.put(CATEGORY_HELPER_METHODS_GET_JDO_OBJECT.getItemKey(), Messages.getString("org.nightlabs.jfire.reporting.admin.oda.jfs.client.ui.JFireReportingExpressionProvider.identifier.resolveJDOObjects")); //$NON-NLS-1$
		identifier2Name.put(CATEGORY_HELPER_METHODS_PERSISTENCE_MANAGER.getItemKey(), Messages.getString("org.nightlabs.jfire.reporting.admin.oda.jfs.client.ui.JFireReportingExpressionProvider.identifier.getPersistenceManager")); //$NON-NLS-1$
		identifier2Name.put(CATEGORY_HELPER_METHODS_VAR.getItemKey(), Messages.getString("org.nightlabs.jfire.reporting.admin.oda.jfs.client.ui.JFireReportingExpressionProvider.identifier.getSharedVariables")); //$NON-NLS-1$
		identifier2Name.put(CATEGORY_HELPER_METHODS_LOGGER.getItemKey(), Messages.getString("org.nightlabs.jfire.reporting.admin.oda.jfs.client.ui.JFireReportingExpressionProvider.identifier.loggerToUse")); //$NON-NLS-1$
