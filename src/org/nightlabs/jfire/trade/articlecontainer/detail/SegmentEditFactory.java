...
public interface SegmentEditFactory
{
	 ...
	 * @param segmentContext The segmentContext declared in the plugin.xml. This can
	 ...
	 */
	void init(String name, String segmentContext, String segmentTypeClass);
	...
	SegmentEdit createSegmentEdit(
			GeneralEditorComposite generalEditorComposite, String segmentContext,
