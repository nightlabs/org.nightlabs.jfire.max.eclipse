...
package org.nightlabs.jfire.trade.articlecontainer.detail.action.addtoinvoice;
...
public class SelectInvoicePage extends DynamicPathWizardPage
{
	...
	{
		super(SelectInvoicePage.class.getName(), Messages.getString("org.nightlabs.jfire.trade.articlecontainer.detail.action.addtoinvoice.SelectInvoicePage.title")); //$NON-NLS-1$
	...
	public Control createPageContents(Composite parent)
	{
		...
		createInvoiceRadio.setText(Messages.getString("org.nightlabs.jfire.trade.articlecontainer.detail.action.addtoinvoice.SelectInvoicePage.createInvoiceRadio.text")); //$NON-NLS-1$
		createInvoiceRadio.setSelection(true);
		selectInvoiceRadio = new Button(page, SWT.RADIO);
		selectInvoiceRadio.setText(Messages.getString("org.nightlabs.jfire.trade.articlecontainer.detail.action.addtoinvoice.SelectInvoicePage.selectInvoiceRadio.text")); //$NON-NLS-1$
		...
		invoiceTable = new AbstractTableComposite(page, SWT.NONE, true, SWT.BORDER | SWT.FULL_SELECTION | SWT.SINGLE) {
			...
			{
				new TableColumn(table, SWT.RIGHT).setText(Messages.getString("org.nightlabs.jfire.trade.articlecontainer.detail.action.addtoinvoice.SelectInvoicePage.invoiceIDTableColumn.text")); //$NON-NLS-1$
				new TableColumn(table, SWT.LEFT).setText(Messages.getString("org.nightlabs.jfire.trade.articlecontainer.detail.action.addtoinvoice.SelectInvoicePage.createDateTableColumn.text")); //$NON-NLS-1$
				new TableColumn(table, SWT.LEFT).setText(Messages.getString("org.nightlabs.jfire.trade.articlecontainer.detail.action.addtoinvoice.SelectInvoicePage.createUserTableColumn.text")); //$NON-NLS-1$
		...
		invoices.add(Messages.getString("org.nightlabs.jfire.trade.articlecontainer.detail.action.addtoinvoice.SelectInvoicePage.loadInvoicesPseudoEntry")); //$NON-NLS-1$
		invoiceTable.setInput(invoices);
		invoiceTable.setEnabled(selectInvoiceRadio.getSelection());

		new Job(Messages.getString("org.nightlabs.jfire.trade.articlecontainer.detail.action.addtoinvoice.SelectInvoicePage.loadInvoicesJob.name")) { //$NON-NLS-1$
