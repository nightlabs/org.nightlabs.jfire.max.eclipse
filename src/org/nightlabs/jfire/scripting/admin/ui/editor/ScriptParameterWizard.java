...
import org.nightlabs.jfire.scripting.admin.ui.resource.*;
...
public class ScriptParameterWizard extends DynamicPathWizard {
	...
	public boolean performFinish() {
		...
		//scriptParameter.setScriptParameterID(scriptParameterID);
		//scriptParameter.setScriptParameterClassName(scriptParameterClassName);
		if(storeOnServer){
