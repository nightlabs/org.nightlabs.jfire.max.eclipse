...
import org.nightlabs.jfire.trade.admin.moneyflow.MoneyFlowMappingTree;
...
extends AbstractProductTypePageController<ProductTypeType> 
{
	...
	public void doLoad(IProgressMonitor monitor) {
		...
		monitor.beginTask(Messages.getString("org.nightlabs.jfire.trade.admin.editor.ProductTypeMoneyFlowConfigPageController.loadMoneyFlowConfigMonitor.task.name"), 2); //$NON-NLS-1$
		monitor.worked(1);
