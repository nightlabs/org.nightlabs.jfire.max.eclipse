...
import org.nightlabs.jfire.trade.admin.moneyflow.LocalAccountantDelegateRegistry;
...
import org.nightlabs.jfire.trade.admin.moneyflow.MappingDimensionRegistry;
...
//	private MoneyFlowMappingConfigurator configurator;
	...
	public AddMoneyFlowMappingWizard(PFMappingAccountantDelegate delegate, ProductTypeID productTypeID) {
		...
		setWindowTitle(Messages.getString("org.nightlabs.jfire.trade.admin.moneyflow.edit.AddMoneyFlowMappingWizard.windowTitle")); //$NON-NLS-1$
	}
