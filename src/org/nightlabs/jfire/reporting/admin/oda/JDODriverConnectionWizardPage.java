...
package org.nightlabs.jfire.reporting.admin.oda;
...
public class JDODriverConnectionWizardPage extends DynamicPathWizardPage {
	...
	public Control createPageContents(Composite parent) {
		...
		organisationID = new LabeledText(wrapper, Messages.getString("org.nightlabs.jfire.reporting.admin.oda.JDODriverConnectionWizardPage.organisationIDLabel.text")); //$NON-NLS-1$
		return wrapper;
	}
