...
import org.nightlabs.jfire.trade.admin.producttype.SaleAccessControlComposite;
import org.nightlabs.jfire.trade.admin.producttype.SaleAccessControlHelper;
...
implements IProductTypeSectionPart
{
	...
	public AbstractSaleAccessControlSection(IProductTypeDetailPage page, Composite parent, int style) {
		this(page, parent, style,
				Messages.getString("org.nightlabs.jfire.trade.admin.editor.AbstractSaleAccessControlSection.title"));		 //$NON-NLS-1$
	}
