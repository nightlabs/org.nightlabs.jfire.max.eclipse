...
import org.nightlabs.jfire.trade.articlecontainer.detail.action.GenericArticleEditAction;
...
extends GenericArticleEditAction
{
	...
	{
		return
				!(getArticleEditActionRegistry().getActiveGeneralEditorActionBarContributor()
	...
	public void run()
	{
		AddToInvoiceWizard addToInvoiceWizard = new AddToInvoiceWizard(getArticles());
