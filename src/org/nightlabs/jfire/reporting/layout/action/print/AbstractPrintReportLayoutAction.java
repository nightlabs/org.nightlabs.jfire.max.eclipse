...
public abstract class AbstractPrintReportLayoutAction extends ReportRegistryItemAction {
	...
	public void runWithRegistryItemIDs(final Collection<ReportRegistryItemID> reportRegistryItems) {
		Job printJob = new Job(Messages.getString("org.nightlabs.jfire.reporting.layout.action.print.AbstractPrintReportLayoutAction.printJob.name")) { //$NON-NLS-1$
			@Override
			protected IStatus run(IProgressMonitor monitor) {
				RCPUtil.getSaveProgressMonitor(monitor).beginTask(Messages.getString("org.nightlabs.jfire.reporting.layout.action.print.AbstractPrintReportLayoutAction.printJob.beginPrintingTask.name"), IProgressMonitor.UNKNOWN); //$NON-NLS-1$
