...
import org.nightlabs.jfire.reporting.layout.ActiveReportRegistryItemTreeController;
import org.nightlabs.jfire.reporting.layout.ReportCategory;
import org.nightlabs.jfire.reporting.layout.ReportLayout;
import org.nightlabs.jfire.reporting.layout.ReportRegistryItem;
import org.nightlabs.jfire.reporting.layout.ReportRegistryItemNode;
import org.nightlabs.jfire.reporting.layout.ReportRegistryItemTree;
...
implements ICellModifier 
{
	...
	public void createTreeColumns(Tree tree) {
		...
		column.setText(Messages.getString("org.nightlabs.jfire.reporting.config.ReportLayoutTree.reportLayoutOrCategoryColumn.text")); //$NON-NLS-1$
		column.setResizable(true);
		// TODO: Set better width
		column.setWidth(310);
		
		TreeColumn availCol = new TreeColumn(getTree(), SWT.CENTER);
		availCol.setText(Messages.getString("org.nightlabs.jfire.reporting.config.ReportLayoutTree.availColumn.text")); //$NON-NLS-1$
		availCol.setResizable(true);
		// TODO: Set better width
		availCol.setWidth(35);
		
		TreeColumn defaultCol = new TreeColumn(getTree(), SWT.CENTER);
		defaultCol.setText(Messages.getString("org.nightlabs.jfire.reporting.config.ReportLayoutTree.defaultColumn.text")); //$NON-NLS-1$
