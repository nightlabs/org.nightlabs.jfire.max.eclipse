package org.nightlabs.jfire.trade.repository.transfer;
...
//		ProductTransfer.FETCH_GROUP_PRODUCT_COUNT,
	...
	protected void createTableColumns(TableViewer tableViewer, Table table)
	{
		...
		tc.setText(Messages.getString("org.nightlabs.jfire.trade.repository.transfer.ProductTransferTable.timeStampColumn.text")); //$NON-NLS-1$
		layout.addColumnData(new ColumnPixelData(140));

		tc = new TableColumn(table, SWT.RIGHT);
		tc.setText(Messages.getString("org.nightlabs.jfire.trade.repository.transfer.ProductTransferTable.productTypeAndQuantityColumn.text")); //$NON-NLS-1$
		layout.addColumnData(new ColumnWeightData(30));

		tc = new TableColumn(table, SWT.LEFT);
		tc.setText(Messages.getString("org.nightlabs.jfire.trade.repository.transfer.ProductTransferTable.directionColumn.text")); //$NON-NLS-1$
		layout.addColumnData(new ColumnPixelData(80));

		tc = new TableColumn(table, SWT.LEFT);
		tc.setText(Messages.getString("org.nightlabs.jfire.trade.repository.transfer.ProductTransferTable.fromOrToColumn.text")); //$NON-NLS-1$
		layout.addColumnData(new ColumnWeightData(30));

		tc = new TableColumn(table, SWT.LEFT);
		tc.setText(Messages.getString("org.nightlabs.jfire.trade.repository.transfer.ProductTransferTable.repositoryOwnerColumn.text")); //$NON-NLS-1$
		layout.addColumnData(new ColumnWeightData(30));

		tc = new TableColumn(table, SWT.LEFT);
		tc.setText(Messages.getString("org.nightlabs.jfire.trade.repository.transfer.ProductTransferTable.userColumn.text")); //$NON-NLS-1$
		layout.addColumnData(new ColumnWeightData(20));

		tc = new TableColumn(table, SWT.RIGHT); // TODO LEFT when localised!
		tc.setText(Messages.getString("org.nightlabs.jfire.trade.repository.transfer.ProductTransferTable.transferTypeColumn.text")); //$NON-NLS-1$
		layout.addColumnData(new ColumnWeightData(20));
	...
	public void setLoadingStatus()
	{
		...
		super.setInput(Messages.getString("org.nightlabs.jfire.trade.repository.transfer.ProductTransferTable.loadingDataPlaceholder")); //$NON-NLS-1$
	}
