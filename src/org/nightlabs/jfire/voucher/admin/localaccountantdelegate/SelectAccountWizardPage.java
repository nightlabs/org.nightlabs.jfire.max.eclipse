...
extends WizardHopPage
{
	...
	{
		super(SelectAccountWizardPage.class.getName(), Messages.getString("org.nightlabs.jfire.voucher.admin.localaccountantdelegate.SelectAccountWizardPage.title")); //$NON-NLS-1$
	...
	public Control createPageContents(Composite parent)
	{
		...
		createAccount.setText(Messages.getString("org.nightlabs.jfire.voucher.admin.localaccountantdelegate.SelectAccountWizardPage.createAccountRadio.text")); //$NON-NLS-1$
		...
		selectAccount.setText(Messages.getString("org.nightlabs.jfire.voucher.admin.localaccountantdelegate.SelectAccountWizardPage.selectAccountRadio.text")); //$NON-NLS-1$
		...
		dummy.getName().setText(Locale.getDefault().getLanguage(), Messages.getString("org.nightlabs.jfire.voucher.admin.localaccountantdelegate.SelectAccountWizardPage.accountList.item_loadingData")); //$NON-NLS-1$
		accountList.addElement(dummy);

		Job job = new Job(Messages.getString("org.nightlabs.jfire.voucher.admin.localaccountantdelegate.SelectAccountWizardPage.loadJob.name")) { //$NON-NLS-1$
			@Implement
