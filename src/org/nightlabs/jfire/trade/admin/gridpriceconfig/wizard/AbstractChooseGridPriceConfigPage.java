...
package org.nightlabs.jfire.trade.admin.gridpriceconfig.wizard;
...
extends WizardHopPage
{
	...
	{
		super(AbstractChooseGridPriceConfigPage.class.getName(), Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.wizard.AbstractChooseGridPriceConfigPage.title")); //$NON-NLS-1$
		this.parentProductTypeID = parentProductTypeID;
		this.setDescription(Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.wizard.AbstractChooseGridPriceConfigPage.description")); //$NON-NLS-1$
		new WizardHop(this);
	...
	private void setInheritPriceConfigRadio_InnerPriceConfigName(String name)
	{
		inheritPriceConfigRadio.setText(
				String.format(
						Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.wizard.AbstractChooseGridPriceConfigPage.inheritPriceConfigRadio.text"), //$NON-NLS-1$
						name)); 
	...
	public Control createPageContents(Composite parent)
	{
		...
		setInheritPriceConfigRadio_InnerPriceConfigName(Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.wizard.AbstractChooseGridPriceConfigPage.pseudoInheritedPriceConfig_loading")); //$NON-NLS-1$
		...
		assignPriceConfigLaterRadio.setText(Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.wizard.AbstractChooseGridPriceConfigPage.assignPriceConfigLaterRadio.text")); //$NON-NLS-1$
		...
		createPriceConfigRadio.setText(Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.wizard.AbstractChooseGridPriceConfigPage.createPriceConfigRadio.text")); //$NON-NLS-1$
		...
		newPriceConfigNameEditor = new I18nTextEditor(page, Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.wizard.AbstractChooseGridPriceConfigPage.newPriceConfigNameEditor.caption")); //$NON-NLS-1$
		...
		selectPriceConfigRadio.setText(Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.wizard.AbstractChooseGridPriceConfigPage.selectPriceConfigRadio.text")); //$NON-NLS-1$
		...
		priceConfigList.add(Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.wizard.AbstractChooseGridPriceConfigPage.pseudoPriceConfig_loading")); //$NON-NLS-1$
		...
		Job job = new Job(Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.wizard.AbstractChooseGridPriceConfigPage.loadPriceConfigsJob.name")) { //$NON-NLS-1$
			protected IStatus run(ProgressMonitor monitor) throws Exception
			{
				try {
					monitor.beginTask(Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.wizard.AbstractChooseGridPriceConfigPage.loadPriceConfigsMonitor.task.name"), 2); //$NON-NLS-1$
					...
					Display.getDefault().asyncExec(new Runnable() {
						public void run()
						{
							...
							if (parentProductType != null && parentProductType.getInnerPriceConfig() != null)
								...
								setInheritPriceConfigRadio_InnerPriceConfigName(Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.wizard.AbstractChooseGridPriceConfigPage.pseudoInheritedPriceConfig_none")); //$NON-NLS-1$
