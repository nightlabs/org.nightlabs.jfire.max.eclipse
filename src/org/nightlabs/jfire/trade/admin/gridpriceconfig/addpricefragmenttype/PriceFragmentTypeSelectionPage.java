...
public class PriceFragmentTypeSelectionPage extends DynamicPathWizardPage
{
	...
	{
		super(PriceFragmentTypeSelectionPage.class.getName(), Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.addpricefragmenttype.PriceFragmentTypeSelectionPage.title")); //$NON-NLS-1$
		setDescription(Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.addpricefragmenttype.PriceFragmentTypeSelectionPage.description")); //$NON-NLS-1$
	}
	...
	public Control createPageContents(Composite parent)
	{
		...
		createNewPriceFragmentTypeRadio.setText(Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.addpricefragmenttype.PriceFragmentTypeSelectionPage.createNewPriceFragmentTypeRadio.text")); //$NON-NLS-1$
		...
		chooseExistingPriceFragmentTypeRadio.setText(Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.addpricefragmenttype.PriceFragmentTypeSelectionPage.chooseExistingPriceFragmentTypeRadio.text")); //$NON-NLS-1$
		...
		priceFragmentTypeList.add(Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.addpricefragmenttype.PriceFragmentTypeSelectionPage.pseudoEntry_loading")); //$NON-NLS-1$
		Job loadJob = new Job(Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.addpricefragmenttype.PriceFragmentTypeSelectionPage.loadPriceFragmentTypesJob.name")) { //$NON-NLS-1$
			@Override
