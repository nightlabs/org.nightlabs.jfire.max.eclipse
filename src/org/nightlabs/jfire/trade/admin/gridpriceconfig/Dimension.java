...
import org.nightlabs.jfire.trade.admin.gridpriceconfig.addcurrency.AddCurrencyWizard;
import org.nightlabs.jfire.trade.admin.gridpriceconfig.addcustomergroup.AddCustomerGroupWizard;
import org.nightlabs.jfire.trade.admin.gridpriceconfig.addpricefragmenttype.AddPriceFragmentTypeWizard;
import org.nightlabs.jfire.trade.admin.gridpriceconfig.addtariff.AddTariffWizard;
...
public abstract class Dimension<DV extends DimensionValue>
{
	...
	public static class CustomerGroupDimension extends Dimension<DimensionValue.CustomerGroupDimensionValue>
	{
		...
		{
			return Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.Dimension.CustomerGroupDimension.name"); //$NON-NLS-1$
		}
		@Override
	...
	public static class CurrencyDimension extends Dimension<DimensionValue.CurrencyDimensionValue>
	{
		...
		public String getName()
		{
			return Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.Dimension.CurrencyDimension.name"); //$NON-NLS-1$
		}
		@Override
	...
	public static class PriceFragmentTypeDimension extends Dimension<DimensionValue.PriceFragmentTypeDimensionValue>
	{
		...
		public String getName()
		{
			return Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.Dimension.PriceFragmentTypeDimension.name"); //$NON-NLS-1$
		}
		@Override
	...
	public static class TariffDimension extends Dimension<DimensionValue.TariffDimensionValue>
	{
		...
		public String getName()
		{
			return Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.Dimension.TariffDimension.name"); //$NON-NLS-1$
		}
		@Override
