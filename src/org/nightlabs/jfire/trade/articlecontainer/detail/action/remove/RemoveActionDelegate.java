...
import org.nightlabs.jfire.trade.articlecontainer.detail.action.ArticleEditActionDelegate;
import org.nightlabs.jfire.trade.articlecontainer.detail.action.IArticleEditAction;

/**
 * You must implement this class, when you want to remove {@link org.nightlabs.jfire.trade.Article}s from an
 * {@link org.nightlabs.jfire.accounting.Invoice} or a {@link org.nightlabs.jfire.store.DeliveryNote}; or
 * when you want to delete the {@link org.nightlabs.jfire.trade.Article}s (removing an <code>Article</code>from an
 * {@link org.nightlabs.jfire.trade.Offer}/{@link org.nightlabs.jfire.trade.Order} is equivalent to deleting
 * it from the datastore).
 * <p>
 * Normally, all you have to do is taking care about your GUI in the method
 * {@link org.nightlabs.jfire.trade.articlecontainer.detail.action.IArticleEditActionDelegate#run(IArticleEditAction, ArticleSelection)}.
 * The work on the server as well as updating the {@link org.nightlabs.jfire.trade.ArticleProductTypeClassGroup}
...
//	 * {@link org.nightlabs.jfire.trade.ArticleProductTypeClassGroup}. It is executed,
//	 * after the server removal has been done (if {@link #isDelegateHandlingRemoteWork()} == false)
//	 * and before {@link org.nightlabs.jfire.trade.articlecontainer.detail.action.IArticleEditActionDelegate#run(IArticleEditAction, ArticleSelection)}
//	 * is called.
//	 * <p>
...
//	 * @param articles The {@link org.nightlabs.jfire.trade.Article}s to be removed.
//	 */
...
//	}
	...
	/**
	 * This implementation removes the {@link org.nightlabs.jfire.trade.Article}s specified by the {@link ArticleSelection}
	 * from the {@link org.nightlabs.jfire.trade.ArticleProductTypeClassGroup} by calling {@link ArticleEdit#removeArticles(Set)}.
	 * This keeps the {@link org.nightlabs.jfire.trade.ArticleSegmentGroups}
	 * up to date. You should update your GUI in {@link ArticleEdit#removeArticles(Set)}.
	 *
	 * @see org.nightlabs.jfire.trade.articlecontainer.detail.action.IArticleEditActionDelegate#run(org.nightlabs.jfire.trade.articlecontainer.detail.action.IArticleEditAction, org.nightlabs.jfire.trade.articlecontainer.detail.ArticleSelection)
	 */
...
//	/**
//	 * Implement this method and remove the {@link org.nightlabs.jfire.trade.Article}s specified by
...
//	 * @param articleSelection The selected {@link org.nightlabs.jfire.trade.Article}s.
//	 */
