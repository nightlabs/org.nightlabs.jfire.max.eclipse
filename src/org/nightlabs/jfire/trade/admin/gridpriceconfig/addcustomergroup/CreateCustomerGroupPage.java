...
public class CreateCustomerGroupPage extends DynamicPathWizardPage
{
	...
	{
		super(CreateCustomerGroupPage.class.getName(), Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.addcustomergroup.CreateCustomerGroupPage.title")); //$NON-NLS-1$
		setDescription(Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.addcustomergroup.CreateCustomerGroupPage.description")); //$NON-NLS-1$
	}
	...
	public Control createPageContents(Composite parent)
	{
		...
		new Label(page, SWT.NONE).setText(Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.addcustomergroup.CreateCustomerGroupPage.nameLabel.text")); //$NON-NLS-1$
