		...
		extends WizardHopPage
{
	...
	{
		super(CreateAccountWizardPage.class.getName(), Messages.getString("org.nightlabs.jfire.voucher.admin.localaccountantdelegate.CreateAccountWizardPage.title")); //$NON-NLS-1$
	...
	public Control createPageContents(Composite parent)
	{
		...
		accountNameEditor = new I18nTextEditor(page, Messages.getString("org.nightlabs.jfire.voucher.admin.localaccountantdelegate.CreateAccountWizardPage.accountNameEditor.caption")); //$NON-NLS-1$
