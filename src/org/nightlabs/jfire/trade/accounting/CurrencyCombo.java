...
implements ISelectionProvider
{
	...
	public CurrencyCombo(Composite parent, int style) {
		...
		combo.add(Messages.getString("org.nightlabs.jfire.trade.accounting.CurrencyCombo.pseudoEntry_loading")); //$NON-NLS-1$
		combo.select(0);

		org.nightlabs.base.ui.job.Job loadCurrenciesJob = new org.nightlabs.base.ui.job.Job(Messages.getString("org.nightlabs.jfire.trade.accounting.CurrencyCombo.loadCurrenciesJob.name")) { //$NON-NLS-1$
