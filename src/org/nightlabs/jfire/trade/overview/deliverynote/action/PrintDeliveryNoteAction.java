...
//		super(editor);
	public PrintDeliveryNoteAction() {
		super();	
		setId(ID);
		setText(Messages.getString("org.nightlabs.jfire.trade.overview.deliverynote.action.PrintDeliveryNoteAction.text")); //$NON-NLS-1$
		setToolTipText(Messages.getString("org.nightlabs.jfire.trade.overview.deliverynote.action.PrintDeliveryNoteAction.toolTipText"));		 //$NON-NLS-1$
	}
