...
public class AccountEditorInput extends JDOObjectEditorInput<AnchorID>
{
	...
	{
		super(accountID);
		setName(String.format(Messages.getString("org.nightlabs.jfire.trade.ui.account.editor.AccountEditorInput.name"), Anchor.getPrimaryKey(accountID.organisationID, accountID.anchorTypeID, accountID.anchorID))); //$NON-NLS-1$
	}
}
