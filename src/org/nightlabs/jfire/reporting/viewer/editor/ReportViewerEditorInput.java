...
public class ReportViewerEditorInput implements IEditorInput {
	...
	public String getName() {
		return Messages.getString("org.nightlabs.jfire.reporting.viewer.editor.ReportViewerEditorInput.name"); //$NON-NLS-1$
	}
	...
	public String getToolTipText() {
		return Messages.getString("org.nightlabs.jfire.reporting.viewer.editor.ReportViewerEditorInput.toolTipText"); //$NON-NLS-1$
	}
