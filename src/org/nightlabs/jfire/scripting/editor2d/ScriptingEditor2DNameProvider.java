...
extends EditorNameProvider 
{
	public String getTypeName(Class c) 
	{
		if (TextScriptDrawComponent.class.isAssignableFrom(c)) {
			return Messages.getString("org.nightlabs.jfire.scripting.editor2d.ScriptingEditor2DNameProvider.textScript"); //$NON-NLS-1$
		}
		if (BarcodeDrawComponent.class.isAssignableFrom(c)) {
			return Messages.getString("org.nightlabs.jfire.scripting.editor2d.ScriptingEditor2DNameProvider.barcode"); //$NON-NLS-1$
		}
