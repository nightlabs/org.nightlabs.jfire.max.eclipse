...
import org.nightlabs.jfire.reporting.admin.parameter.editpart.tree.ValueProviderConfigTreeEditPart;
import org.nightlabs.jfire.reporting.admin.parameter.resource.Messages;
import org.nightlabs.jfire.reporting.admin.parameter.tool.ConnectionToolEntry;
import org.nightlabs.jfire.reporting.admin.parameter.tool.ValueProviderToolEntry;
...
public class PaletteFactory 
{
	...
	{
		PaletteGroup toolGroup = new PaletteGroup(Messages.getString("org.nightlabs.jfire.reporting.admin.parameter.PaletteFactory.paletteGroup.tools.name")); //$NON-NLS-1$
	...
	{
		PaletteDrawer componentsDrawer = new PaletteDrawer(Messages.getString("org.nightlabs.jfire.reporting.admin.parameter.PaletteFactory.paletteGroup.model.name")); //$NON-NLS-1$
	...
	protected ToolEntry createConnectionToolEntry() 
	{
		return new ConnectionCreationToolEntry(
				Messages.getString("org.nightlabs.jfire.reporting.admin.parameter.PaletteFactory.connectionTool.label"), //$NON-NLS-1$
				Messages.getString("org.nightlabs.jfire.reporting.admin.parameter.PaletteFactory.connectionTool.shortDesc"), //$NON-NLS-1$
				null,
...
//	}
	...
	protected ToolEntry createValueProviderToolEntry()
	{
		return new ValueProviderToolEntry(
				Messages.getString("org.nightlabs.jfire.reporting.admin.parameter.PaletteFactory.providerTool.label"), //$NON-NLS-1$
				Messages.getString("org.nightlabs.jfire.reporting.admin.parameter.PaletteFactory.providerTool.shortDesc"), //$NON-NLS-1$
