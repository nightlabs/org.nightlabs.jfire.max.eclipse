...
public class PaymentControllerImpl extends AbstractPaymentController {
	...
	/* (non-Javadoc)
	 * @see org.nightlabs.jfire.trade.transfer.pay.PaymentController#clientBegin()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.nightlabs.jfire.trade.transfer.pay.PaymentController#clientDoWork()
	 */
	@Override
...
//		setTransferIDs(paymentIDs);
	...
	/* (non-Javadoc)
	 * @see org.nightlabs.jfire.trade.transfer.pay.PaymentController#clientEnd()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.nightlabs.jfire.trade.transfer.pay.PaymentController#verifyData()
	 */
	@Override
