...
extends RestorableSectionPart
{
	...
	public RepositoryGeneralSection(FormPage page, Composite parent)
	{
		...
		getSection().setText(Messages.getString("org.nightlabs.jfire.trade.repository.editor.RepositoryGeneralSection.text")); //$NON-NLS-1$
		getSection().setLayoutData(new GridData(GridData.FILL_BOTH));
		getSection().setLayout(new GridLayout());

		XComposite client = new XComposite(getSection(), SWT.NONE, LayoutMode.TIGHT_WRAPPER);
		repositoryName = new I18nTextEditorTable(client, Messages.getString("org.nightlabs.jfire.trade.repository.editor.RepositoryGeneralSection.repositoryNameEditor.title")); //$NON-NLS-1$
