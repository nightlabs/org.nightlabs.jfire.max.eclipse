...
import org.nightlabs.jfire.voucher.admin.localaccountantdelegate.VoucherLocalAccountantDelegateComposite;
		...
		extends WizardHopPage
{
	...
	{
		super(CreateLocalAccountantDelegatePage.class.getName(), Messages.getString("org.nightlabs.jfire.voucher.admin.createvouchertype.CreateLocalAccountantDelegatePage.title"), //$NON-NLS-1$
				SharedImages.getWizardPageImageDescriptor(VoucherAdminPlugin.getDefault(), CreateLocalAccountantDelegatePage.class));
		setDescription(Messages.getString("org.nightlabs.jfire.voucher.admin.createvouchertype.CreateLocalAccountantDelegatePage.description")); //$NON-NLS-1$
	}
	...
	public Control createPageContents(Composite parent)
	{
		...
		accountantDelegateNameEditor = new I18nTextEditor(page, Messages.getString("org.nightlabs.jfire.voucher.admin.createvouchertype.CreateLocalAccountantDelegatePage.accountantDelegateNameEditor.caption")); //$NON-NLS-1$
