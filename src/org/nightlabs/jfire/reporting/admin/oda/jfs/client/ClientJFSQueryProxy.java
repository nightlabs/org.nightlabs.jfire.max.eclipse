...
package org.nightlabs.jfire.reporting.admin.oda.jfs.client;
...
//		System.out.println("Constructor of "+this.getClass().getName()+" called.");
	...
	public IParameterMetaData getParameterMetaData() throws OdaException {
		...
		try {
			lastParameterMetaData = ReportingAdminPlugin.getReportManager().getJFSParameterMetaData(itemID);
		} catch (Exception e) {
	...
	public IResultSet executeQuery() throws OdaException {
		try {
			return ReportingPlugin.getReportManager().getJFSResultSet(
	...
	public IResultSetMetaData getMetaData() throws OdaException {
		...
		try {
			lastMetaData = ReportingPlugin.getReportManager().getJFSResultSetMetaData(getJFSQueryPropertySet());
		} catch (Exception e) {
