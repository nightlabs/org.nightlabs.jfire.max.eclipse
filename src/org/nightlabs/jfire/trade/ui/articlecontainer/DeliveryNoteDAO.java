...
public class DeliveryNoteDAO
		extends BaseJDOObjectDAO<DeliveryNoteID, DeliveryNote>
{
	...
	public DeliveryNote getDeliveryNote(DeliveryNoteID deliveryNoteID, String[] fetchGroups, int maxFetchDepth, ProgressMonitor monitor)
	{
		return getJDOObject(null, deliveryNoteID, fetchGroups, maxFetchDepth, monitor);
	}

	public List<DeliveryNote> getDeliveryNotes(Set<DeliveryNoteID> deliveryNoteIDs, String[] fetchGroups, int maxFetchDepth, ProgressMonitor monitor)
	{
			...
			String[] fetchGroups, int maxFetchDepth, ProgressMonitor monitor)
	{
		try {
			...
			Map<DeliveryNoteID, DeliveryNote> deliveryNoteMap = new HashMap<DeliveryNoteID, DeliveryNote>(deliveryNoteIDs.size());
		...
		String[] fetchGroups, int maxFetchDepth, ProgressMonitor monitor)
	{
		try
		{
			...
			throw new RuntimeException("Couldn't retrieve DeliveryNotes by Queries:", e);  //$NON-NLS-1$
		}
	}
}
