...
import org.nightlabs.jfire.simpletrade.admin.editor.SimpleProductTypeEditor;
import org.nightlabs.jfire.simpletrade.admin.gridpriceconfig.ChooseSimpleTradePriceConfigPage;
...
//	private ProductTypeTreeNode selectedNode;
	...
	public CreateProductTypeWizard(ProductTypeID parentProductTypeID)
	{
		...
		setWindowTitle(Messages.getString("org.nightlabs.jfire.simpletrade.admin.producttype.create.CreateProductTypeWizard.windowTitle")); //$NON-NLS-1$
	}
			...
			getContainer().run(false, false, new IRunnableWithProgress() {
				...
				public void run(IProgressMonitor _monitor) throws InvocationTargetException, InterruptedException {
					try {
						...
						monitor.beginTask(Messages.getString("org.nightlabs.jfire.simpletrade.admin.producttype.create.CreateProductTypeWizard.createSimpleProductTypeMonitor.task.name"), 3); //$NON-NLS-1$
