...
package org.nightlabs.jfire.trade.legalentity.edit;
...
public class LegalEntityEditorWizardOtherPage extends
	...
	public LegalEntityEditorWizardOtherPage(Person person) {
		super(
			...
			Messages.getString("org.nightlabs.jfire.trade.legalentity.edit.LegalEntityEditorWizardOtherPage.title"), //$NON-NLS-1$
			person,
			null
		);
