...
public class MoneyTransferPage extends EntityEditorPageWithProgress
{
	...
	{
		super(editor, ID_PAGE, Messages.getString("org.nightlabs.jfire.trade.editor.account.ManualMoneyTransferPage.pageTitle")); //$NON-NLS-1$
	}
	...
	protected String getPageFormTitle() {
		return Messages.getString("org.nightlabs.jfire.trade.editor.account.ManualMoneyTransferPage.pageFormTitle"); //$NON-NLS-1$
	}
}
