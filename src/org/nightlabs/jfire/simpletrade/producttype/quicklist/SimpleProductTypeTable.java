...
public class SimpleProductTypeTable extends AbstractTableComposite<SimpleProductType> {
	...
	protected void createTableColumns(TableViewer tableViewer, Table table) {
		new TableColumn(table, SWT.LEFT).setText(Messages.getString("org.nightlabs.jfire.simpletrade.producttype.quicklist.SimpleProductTypeTable.nameTableColumn.text")); //$NON-NLS-1$
