...
public abstract class HeaderTreeNode
{
	public static abstract class RootNode extends HeaderTreeNode
	{
		...
		/**
		 * @see org.nightlabs.jfire.trade.articlecontainer.header.HeaderTreeNode#getColumnText(int)
		 */
	...
	/**
	 * @see org.nightlabs.jfire.trade.articlecontainer.header.HeaderTreeNode#hasChildren()
	 */
	...
	{
		if (children == null) {
			SimpleNode loadingDataNode = new SimpleNode(this, POSITION_LAST_CHILD, Messages.getString("org.nightlabs.jfire.trade.articlecontainer.header.HeaderTreeNode.loadingDataNode.name"), false); //$NON-NLS-1$
			children = new ArrayList<HeaderTreeNode>(1);
			children.add(loadingDataNode);

			currentJob = new Job(Messages.getString("org.nightlabs.jfire.trade.articlecontainer.header.HeaderTreeNode.loadJob.name")) { //$NON-NLS-1$
