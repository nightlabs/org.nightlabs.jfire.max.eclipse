...
extends XComposite 
{
	...
	protected void createComposite(Composite parent) 
	{
		...
		browseButton.setText(Messages.getString("org.nightlabs.jfire.voucher.admin.editor.VoucherLayoutComposite.browseButton.text")); //$NON-NLS-1$
	...
	public void setVoucherType(VoucherType voucherType) 
	{
		...
		if (voucherType != null) {
			if (voucherType.getVoucherLayout() != null) {
				...
				voucherLayoutText.setText(Messages.getString("org.nightlabs.jfire.voucher.admin.editor.VoucherLayoutComposite.voucherLayoutText.text_noVoucherLayoutAssigned")); //$NON-NLS-1$
			}			
		}
		else {
			voucherLayoutText.setText(Messages.getString("org.nightlabs.jfire.voucher.admin.editor.VoucherLayoutComposite.voucherLayoutText.text_noVoucherType")); //$NON-NLS-1$
		}
	}
