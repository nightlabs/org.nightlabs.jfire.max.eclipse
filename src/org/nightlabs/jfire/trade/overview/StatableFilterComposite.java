...
extends JDOQueryComposite
{
	...
	{		
		...
		group.setText(Messages.getString("org.nightlabs.jfire.trade.overview.StatableFilterComposite.group.text"));		 //$NON-NLS-1$
		...
		activeButton.setText(Messages.getString("org.nightlabs.jfire.trade.overview.StatableFilterComposite.activeButton.text")); //$NON-NLS-1$
		...
		onlyInSelectedStateButton.setText(Messages.getString("org.nightlabs.jfire.trade.overview.StatableFilterComposite.onlyInSelectedStateButton.text")); //$NON-NLS-1$
	...
	public void setStatableClass(final Class statableClass) 
	{
		...
		Job job = new Job(Messages.getString("org.nightlabs.jfire.trade.overview.StatableFilterComposite.loadProcessDefinitionsJob.name")) { //$NON-NLS-1$
			@Override
