...
extends HeaderTreeNode.RootNode
{
	...
	{
		super(headerTreeComposite, Messages.getString("org.nightlabs.jfire.trade.articlecontainer.header.PurchaseRootTreeNode.name"), headerTreeComposite.imageCustomerRootTreeNode); //$NON-NLS-1$
