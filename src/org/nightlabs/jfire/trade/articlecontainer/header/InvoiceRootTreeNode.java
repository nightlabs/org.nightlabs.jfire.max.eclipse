...
public class InvoiceRootTreeNode extends ArticleContainerRootTreeNode
{
	...
	{
		super(parent, Messages.getString("org.nightlabs.jfire.trade.articlecontainer.header.InvoiceRootTreeNode.name"), parent.getHeaderTreeComposite().imageInvoiceRootTreeNode, customerSide); //$NON-NLS-1$
		init();
	}
