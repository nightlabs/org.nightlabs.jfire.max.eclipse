		...
		try {
			getContainer().run(false, false, new IRunnableWithProgress() {
				public void run(IProgressMonitor monitor) throws InvocationTargetException, InterruptedException {
					try {
						monitor.beginTask(Messages.getString("org.nightlabs.jfire.trade.ui.transfer.deliver.DeliveryQueueDeliveryWizard.performFinish.monitor.task.name"), 4); //$NON-NLS-1$
