...
import org.nightlabs.jfire.reporting.admin.oda.jfs.client.ClientJFSDriver;
...
//		wrapper = new XComposite(parent, SWT.NONE, LayoutMode.TIGHT_WRAPPER);
		...
		propertyGroup.setText(Messages.getString("org.nightlabs.jfire.reporting.admin.oda.jfs.client.ui.JFSQueryPropertySetWizardPage.propertyGroup.text")); //$NON-NLS-1$
		...
		setControl(wrapper);
		setMessage(Messages.getString("org.nightlabs.jfire.reporting.admin.oda.jfs.client.ui.JFSQueryPropertySetWizardPage.message")); //$NON-NLS-1$
		refresh(null);
	}
