...
public class VoucherTypeNamePage extends DynamicPathWizardPage
{
	...
	{
		super(VoucherTypeNamePage.class.getName(), Messages.getString("org.nightlabs.jfire.voucher.admin.createvouchertype.VoucherTypeNamePage.title"), //$NON-NLS-1$
				SharedImages.getWizardPageImageDescriptor(VoucherAdminPlugin.getDefault(), VoucherTypeNamePage.class));
		this.setDescription(Messages.getString("org.nightlabs.jfire.voucher.admin.createvouchertype.VoucherTypeNamePage.description")); //$NON-NLS-1$
	...
	public Control createPageContents(Composite parent)
	{
		...
		inheritanceNatureCombo.add(Messages.getString("org.nightlabs.jfire.voucher.admin.createvouchertype.VoucherTypeNamePage.inheritanceNatureCombo.item_node")); //$NON-NLS-1$
		inheritanceNatureCombo.add(Messages.getString("org.nightlabs.jfire.voucher.admin.createvouchertype.VoucherTypeNamePage.inheritanceNatureCombo.item_leaf")); //$NON-NLS-1$
		...
		new Label(page, SWT.NONE).setText(Messages.getString("org.nightlabs.jfire.voucher.admin.createvouchertype.VoucherTypeNamePage.nameLabel.text")); //$NON-NLS-1$
