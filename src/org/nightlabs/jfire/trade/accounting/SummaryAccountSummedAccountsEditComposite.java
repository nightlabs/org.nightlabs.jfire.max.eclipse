...
//implements IAccountContainer
{
			...
			IDirtyStateManager dirtyStateManager, boolean showButtons) 
	{
		...
		label.setText(Messages.getString("org.nightlabs.jfire.trade.accounting.SummaryAccountSummedAccountsEditComposite.descriptionLabel.text")); //$NON-NLS-1$
		...
		if (showButtons) {
			...
			addButton.setText(Messages.getString("org.nightlabs.jfire.trade.accounting.SummaryAccountSummedAccountsEditComposite.addButton.text")); //$NON-NLS-1$
			addButton.setLayoutData(new GridData(GridData.FILL_HORIZONTAL));
			addButton.addSelectionListener(addButtonListener);

			removeButton = new Button(buttonWrapper, SWT.PUSH);
			removeButton.setText(Messages.getString("org.nightlabs.jfire.trade.accounting.SummaryAccountSummedAccountsEditComposite.removeButton.text")); //$NON-NLS-1$
