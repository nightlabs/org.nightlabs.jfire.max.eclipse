...
public class ReportParameterWizard extends DynamicPathWizard{
	...
	public ReportParameterWizard(ReportRegistryItemID reportLayoutID) {
		...
		if (setup.getValueAcquisitionSetups().size() > 1) {
			ReportParameterAcquisitionUseCaseWizardPage wizardPage = new ReportParameterAcquisitionUseCaseWizardPage(Messages.getString("org.nightlabs.jfire.reporting.parameter.ReportParameterWizard.wizardPage.pageName"), reportLayoutID); //$NON-NLS-1$
