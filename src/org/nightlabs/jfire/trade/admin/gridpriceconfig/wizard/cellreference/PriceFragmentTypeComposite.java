...
//		priceFragmentTypeTableGroup.setText(Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.wizard.cellreference.PriceFragmentTypeComposite.priceFragmentTypeTableGroup.text")); //$NON-NLS-1$
