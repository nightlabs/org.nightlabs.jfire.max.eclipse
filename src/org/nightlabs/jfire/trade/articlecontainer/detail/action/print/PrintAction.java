...
package org.nightlabs.jfire.trade.articlecontainer.detail.action.print;
...
public class PrintAction extends ArticleContainerReportAction
{
	...
	public void run()
	{
		Job printJob = new Job(Messages.getString("org.nightlabs.jfire.trade.articlecontainer.detail.action.print.PrintAction.printJob.name")) { //$NON-NLS-1$
			@Override
