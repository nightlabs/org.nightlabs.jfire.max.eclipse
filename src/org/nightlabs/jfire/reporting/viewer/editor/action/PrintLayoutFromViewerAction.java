 ...
 * 
 */
package org.nightlabs.jfire.reporting.viewer.editor.action;
...
import org.nightlabs.jfire.reporting.layout.action.print.PrintReportLayoutUtil;
import org.nightlabs.jfire.reporting.resource.Messages;
import org.nightlabs.jfire.reporting.viewer.editor.ReportViewerEditor;
...
public class PrintLayoutFromViewerAction extends Action {
	...
	public PrintLayoutFromViewerAction(ReportViewerEditor reportViewerEditor) {
		super(Messages.getString("org.nightlabs.jfire.reporting.viewer.editor.action.PrintLayoutFromViewerAction.text")); //$NON-NLS-1$
	...
	@Override
	public void run() {
		Job printJob = new Job(Messages.getString("org.nightlabs.jfire.reporting.viewer.editor.action.PrintLayoutFromViewerAction.printJob.name")) { //$NON-NLS-1$
			@Override
