...
implements IWorkbenchPreferencePage 
{
	...
	protected Control createContents(Composite parent) {
		...
		description.setText(Messages.getString("org.nightlabs.jfire.reporting.config.DefaultReportViewerPreferencePage.descriptionLabel.text")); //$NON-NLS-1$
		description.setLayoutData(new GridData(GridData.FILL_HORIZONTAL));
		useAcrobatJavaBeanForPDFs = new Button(wrapper, SWT.CHECK);
		useAcrobatJavaBeanForPDFs.setText(Messages.getString("org.nightlabs.jfire.reporting.config.DefaultReportViewerPreferencePage.useAcrobatJavaBeanForPDFsButton.text")); //$NON-NLS-1$
