...
public class ArticleAdderComposite extends FadeableComposite
{
	...
	public ArticleAdderComposite(Composite parent, ArticleAdder articleAdder, Collection tariffPricePairs)
	{
		...
		if (tariffCombo.getItemCount() > 0)
			...
			tariffCombo.add(Messages.getString("org.nightlabs.jfire.simpletrade.articlecontainer.detail.ArticleAdderComposite.tariffComboPseudoEntry_noTariffAvailable")); //$NON-NLS-1$
	...
	private void qtySelected(final int qty)
	{
		...
		FadeableCompositeJob addJob = new FadeableCompositeJob(Messages.getString("org.nightlabs.jfire.simpletrade.articlecontainer.detail.ArticleAdderComposite.addArticlesJob.name"), this, this) { //$NON-NLS-1$
			@Override
