...
//		super(editor);
	public ShowDeliveryNoteAction() {
		super();	
		setId(ID);
		setText(Messages.getString("org.nightlabs.jfire.trade.overview.deliverynote.action.ShowDeliveryNoteAction.text")); //$NON-NLS-1$
		setToolTipText(Messages.getString("org.nightlabs.jfire.trade.overview.deliverynote.action.ShowDeliveryNoteAction.toolTipText"));		 //$NON-NLS-1$
	}
