...
public class OrderRootTreeNode extends ArticleContainerRootTreeNode
{
	...
	{
		super(parent, Messages.getString("org.nightlabs.jfire.trade.articlecontainer.header.OrderRootTreeNode.name"), parent.getHeaderTreeComposite().imageOrderRootTreeNode, customerSide); //$NON-NLS-1$
		init();
	}
