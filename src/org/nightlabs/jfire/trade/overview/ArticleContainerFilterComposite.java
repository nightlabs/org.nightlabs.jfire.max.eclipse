...
//		GridLayout layout = new GridLayout(4, false);
		...
		createDTGroup.setText(Messages.getString("org.nightlabs.jfire.trade.overview.ArticleContainerFilterComposite.createDateGroup.text")); //$NON-NLS-1$
		...
		createDTMin = new DateTimeEdit(createDTGroup, dateTimeEditStyle, Messages.getString("org.nightlabs.jfire.trade.overview.ArticleContainerFilterComposite.createDateMin.caption")); //$NON-NLS-1$
		createDTMin.setLayoutData(new GridData(GridData.FILL_HORIZONTAL));
		createDTMax = new DateTimeEdit(createDTGroup, dateTimeEditStyle, Messages.getString("org.nightlabs.jfire.trade.overview.ArticleContainerFilterComposite.createDateMax.caption")); //$NON-NLS-1$
		...
		userGroup.setText(Messages.getString("org.nightlabs.jfire.trade.overview.ArticleContainerFilterComposite.userGroup.text")); //$NON-NLS-1$
		...
		userActiveButton.setText(Messages.getString("org.nightlabs.jfire.trade.overview.ArticleContainerFilterComposite.userActiveButton.text")); //$NON-NLS-1$
		...
		userBrowseButton.setText(Messages.getString("org.nightlabs.jfire.trade.overview.ArticleContainerFilterComposite.userBrowseButton.text")); //$NON-NLS-1$
		...
		vendorGroup.setText(Messages.getString("org.nightlabs.jfire.trade.overview.ArticleContainerFilterComposite.vendorGroup.text")); //$NON-NLS-1$
		...
		vendorActiveButton.setText(Messages.getString("org.nightlabs.jfire.trade.overview.ArticleContainerFilterComposite.vendorActiveButton.text")); //$NON-NLS-1$
		...
		vendorBrowseButton.setText(Messages.getString("org.nightlabs.jfire.trade.overview.ArticleContainerFilterComposite.vendorBrowseButton.text")); //$NON-NLS-1$
		...
		customerGroup.setText(Messages.getString("org.nightlabs.jfire.trade.overview.ArticleContainerFilterComposite.customerGroup.text")); //$NON-NLS-1$
		...
		customerActiveButton.setText(Messages.getString("org.nightlabs.jfire.trade.overview.ArticleContainerFilterComposite.customerActiveButton.text")); //$NON-NLS-1$
		...
		customerBrowseButton.setText(Messages.getString("org.nightlabs.jfire.trade.overview.ArticleContainerFilterComposite.customerBrowseButton.text")); //$NON-NLS-1$
