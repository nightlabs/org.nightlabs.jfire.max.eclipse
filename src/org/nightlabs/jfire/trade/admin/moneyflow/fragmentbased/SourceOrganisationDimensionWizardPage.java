...
//	}
	...
	public SourceOrganisationDimensionWizardPage() {
		super(SourceOrganisationDimensionWizardPage.class.getName(), Messages.getString("org.nightlabs.jfire.trade.admin.moneyflow.fragmentbased.SourceOrganisationDimensionWizardPage.title")); //$NON-NLS-1$
	}
...
//	}
	...
	public Control createPageContents(Composite parent) {
		...
		label.setText(Messages.getString("org.nightlabs.jfire.trade.admin.moneyflow.fragmentbased.SourceOrganisationDimensionWizardPage.notYetFullySupportedLabel.text")); //$NON-NLS-1$
		return wrapper;
	}

	/**
	 * @see org.nightlabs.jfire.trade.admin.moneyflow.MappingDimensionWizardPage#getMoneyFlowMappingDimensionID()
	 */
	...
	/**
	 * @see org.nightlabs.jfire.trade.admin.moneyflow.MappingDimensionWizardPage#getDimensionValue()
	 */
