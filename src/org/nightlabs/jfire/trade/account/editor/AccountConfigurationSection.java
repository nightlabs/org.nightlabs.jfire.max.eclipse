...
import org.nightlabs.jfire.trade.accounting.AccountConfigurationComposite;
...
extends MessageSectionPart
{
	...
	public AccountConfigurationSection(IFormPage page, Composite parent) 
	{
		super(page, parent, 
				...
				Messages.getString("org.nightlabs.jfire.trade.account.editor.AccountConfigurationSection.title")); //$NON-NLS-1$
