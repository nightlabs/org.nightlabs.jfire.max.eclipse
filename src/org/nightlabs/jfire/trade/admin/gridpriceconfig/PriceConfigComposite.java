...
import org.nightlabs.jfire.trade.admin.gridpriceconfig.wizard.AbstractChooseGridPriceConfigPage;
...
//		);
	...
	protected Composite createNoPriceConfigAssignedComposite(Composite parent) 
	{
		...
		label.setText(Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.PriceConfigComposite.noPriceConfigAssignedLabel.text")); //$NON-NLS-1$
		Button assignButton = new Button(noPriceConfigComp, SWT.NONE);
		assignButton.setText(Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.PriceConfigComposite.assignButton.text")); //$NON-NLS-1$
