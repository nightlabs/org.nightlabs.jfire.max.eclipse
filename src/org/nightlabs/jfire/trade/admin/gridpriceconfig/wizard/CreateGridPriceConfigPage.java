...
public class CreateGridPriceConfigPage extends WizardHopPage
{
	...
	{
		super(CreateGridPriceConfigPage.class.getName(), Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.wizard.CreateGridPriceConfigPage.title")); //$NON-NLS-1$
		this.setDescription(Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.wizard.CreateGridPriceConfigPage.description")); //$NON-NLS-1$
	}
	...
	public Control createPageContents(Composite parent)
	{
		...
		new Label(page, SWT.NONE).setText(Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.wizard.CreateGridPriceConfigPage.nameLabel.text")); //$NON-NLS-1$
