...
//		customerGroupListGroup.setText(Messages.getString("org.nightlabs.jfire.trade.admin.ui.gridpriceconfig.wizard.cellreference.CustomerGroupComposite.customerGroupListGroup.text")); //$NON-NLS-1$
