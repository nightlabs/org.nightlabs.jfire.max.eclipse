...
package org.nightlabs.jfire.reporting.layout.action.view;
...
import org.nightlabs.jfire.reporting.layout.action.ReportRegistryItemAction;
import org.nightlabs.jfire.reporting.layout.id.ReportRegistryItemID;
import org.nightlabs.jfire.reporting.layout.render.RenderReportRequest;
import org.nightlabs.jfire.reporting.parameter.ReportParameterWizard;
import org.nightlabs.jfire.reporting.parameter.ReportParameterWizard.Result;
import org.nightlabs.jfire.reporting.resource.Messages;
import org.nightlabs.jfire.reporting.viewer.ReportViewer;
import org.nightlabs.jfire.reporting.viewer.ReportViewerFactory;
import org.nightlabs.jfire.reporting.viewer.ReportViewerRegistry;
...
public abstract class AbstractViewReportLayoutAction extends ReportRegistryItemAction {
	...
	/* (non-Javadoc)
	 * @see org.nightlabs.jfire.reporting.layout.action.ReportRegistryItemAction#run(java.util.Collection)
	 */
	@Override
	...
	public void runWithRegistryItemIDs(final Collection<ReportRegistryItemID> reportRegistryItems) {
		Job viewJob = new Job(Messages.getString("org.nightlabs.jfire.reporting.layout.action.view.AbstractViewReportLayoutAction.printJob.name")) { //$NON-NLS-1$
