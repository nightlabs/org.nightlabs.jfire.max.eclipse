package org.nightlabs.jfire.trade.account.transfer;
...
extends AbstractTableComposite<MoneyTransfer>
{
	...
	protected void createTableColumns(TableViewer tableViewer, Table table)
	{
		...
		tc.setText(Messages.getString("org.nightlabs.jfire.trade.account.transfer.MoneyTransferTable.fromAccountTableColumn.text")); //$NON-NLS-1$
		layout.addColumnData(new ColumnWeightData(30));

		tc = new TableColumn(table, SWT.LEFT);
		tc.setText(Messages.getString("org.nightlabs.jfire.trade.account.transfer.MoneyTransferTable.toAccountableColumn.text")); //$NON-NLS-1$
		layout.addColumnData(new ColumnWeightData(30));

		tc = new TableColumn(table, SWT.LEFT);
		tc.setText(Messages.getString("org.nightlabs.jfire.trade.account.transfer.MoneyTransferTable.amountTableColumn.text")); //$NON-NLS-1$
		layout.addColumnData(new ColumnWeightData(20));

		tc = new TableColumn(table, SWT.LEFT);
		tc.setText(Messages.getString("org.nightlabs.jfire.trade.account.transfer.MoneyTransferTable.reasonTableColumn.text")); //$NON-NLS-1$
		layout.addColumnData(new ColumnWeightData(20));
