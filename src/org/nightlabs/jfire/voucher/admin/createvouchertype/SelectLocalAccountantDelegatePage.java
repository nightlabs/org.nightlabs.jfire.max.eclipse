...
extends WizardHopPage
{
	...
	{
		super(SelectLocalAccountantDelegatePage.class.getName(), Messages.getString("org.nightlabs.jfire.voucher.admin.createvouchertype.SelectLocalAccountantDelegatePage.title"), //$NON-NLS-1$
				SharedImages.getWizardPageImageDescriptor(VoucherAdminPlugin.getDefault(), SelectLocalAccountantDelegatePage.class));
		setDescription(Messages.getString("org.nightlabs.jfire.voucher.admin.createvouchertype.SelectLocalAccountantDelegatePage.description")); //$NON-NLS-1$
	...
	public Control createPageContents(Composite parent)
	{
		...
		mode = Mode.INHERIT;
		setInheritedLocalAccountantDelegateName(Messages.getString("org.nightlabs.jfire.voucher.admin.createvouchertype.SelectLocalAccountantDelegatePage.inheritedLocalAccountantDelegateName_loadingData")); //$NON-NLS-1$
		...
		createAccountantDelegate.setText(Messages.getString("org.nightlabs.jfire.voucher.admin.createvouchertype.SelectLocalAccountantDelegatePage.createAccountantDelegateRadio.text")); //$NON-NLS-1$
		...
		selectAccountantDelegate.setText(Messages.getString("org.nightlabs.jfire.voucher.admin.createvouchertype.SelectLocalAccountantDelegatePage.selectAccountantDelegateRadio.text")); //$NON-NLS-1$
		...
		dummy.getName().setText(Locale.getDefault().getLanguage(), Messages.getString("org.nightlabs.jfire.voucher.admin.createvouchertype.SelectLocalAccountantDelegatePage.accountantDelegateList.item_loadingData")); //$NON-NLS-1$
		accountantDelegateList.addElement(dummy);

		Job job = new Job(Messages.getString("org.nightlabs.jfire.voucher.admin.createvouchertype.SelectLocalAccountantDelegatePage.loadJob.name")) { //$NON-NLS-1$
			@Implement
				...
				Display.getDefault().asyncExec(new Runnable()
				{
					public void run()
					{
						...
						if (inheritedLocalAccountantDelegate == null)
							setInheritedLocalAccountantDelegateName(Messages.getString("org.nightlabs.jfire.voucher.admin.createvouchertype.SelectLocalAccountantDelegatePage.inheritedLocalAccountantDelegateName_noneAssigned")); //$NON-NLS-1$
						else
	...
	{
		inheritAccountantDelegate.setText(String.format(Messages.getString("org.nightlabs.jfire.voucher.admin.createvouchertype.SelectLocalAccountantDelegatePage.inheritAccountantDelegateRadio.text"), name)); //$NON-NLS-1$
	}
