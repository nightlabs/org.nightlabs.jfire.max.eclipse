...
import org.nightlabs.jfire.reporting.admin.parameter.dialog.ShowXMLInitialisationDialog;
import org.nightlabs.jfire.reporting.admin.parameter.dialog.UseCaseDialog;
...
/******************************* Inner class OutlinePage BEGIN *********************************/	
	...
	implements IAdaptable
	{
		...
		protected void configureOutlineViewer(){
			...
			"org.nightlabs.jfire.reporting.admin.parameter.outline.contextmenu", //$NON-NLS-1$
...
//		getActionRegistry().getAction(AutoLayoutAction.ID).run();
	...
	public void createPartControl(Composite parent) 
	{
		...
		defaultUseCaseButton.setText(Messages.getString("org.nightlabs.jfire.reporting.admin.parameter.ReportParameterEditor.defaultUseCaseButton.text")); //$NON-NLS-1$
		defaultUseCaseButton.addSelectionListener(defaultUseCaseButtonListener);
		editUseCaseButton = new Button(topWrapper, SWT.NONE);
		editUseCaseButton.setText(Messages.getString("org.nightlabs.jfire.reporting.admin.parameter.ReportParameterEditor.editUseCaseButton.text")); //$NON-NLS-1$
		editUseCaseButton.addSelectionListener(editUseCaseButtonListener);
		newUseCaseButton = new Button(topWrapper, SWT.NONE);
		newUseCaseButton.setText(Messages.getString("org.nightlabs.jfire.reporting.admin.parameter.ReportParameterEditor.newUseCaseButton.text")); //$NON-NLS-1$
		...
		showXMLInitializationCode.setText(Messages.getString("org.nightlabs.jfire.reporting.admin.parameter.ReportParameterEditor.showXMLInitializationCodeButton.text")); //$NON-NLS-1$
