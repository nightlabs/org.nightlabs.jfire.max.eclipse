...
/**
 * The default PersonRelationTreeLabelProviderDelegate that should be plugged into the {@link PersonRelationTree}'s collection
	...
	public Image getJDOObjectImage(ObjectID jdoObjectID, Object jdoObject, int spanColIndex) {
		if (jdoObject != null && spanColIndex == 0) {
			...
			if (hasImageForPersonRelationTypeID(personRelationTypeID))
				return SharedImages.getSharedImage(PersonRelationPlugin.getDefault(), PersonRelationTreeLabelProviderDelegate.class, personRelationTypeID);
		}
