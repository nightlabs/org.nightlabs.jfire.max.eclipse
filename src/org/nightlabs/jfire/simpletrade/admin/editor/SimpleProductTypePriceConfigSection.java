...
import org.nightlabs.jfire.simpletrade.admin.gridpriceconfig.PriceConfigComposite;
...
extends AbstractGridPriceConfigSection
{
	...
	public SimpleProductTypePriceConfigSection(IFormPage page, Composite parent, int style) {
		super(page, parent, style, Messages.getString("org.nightlabs.jfire.simpletrade.admin.editor.SimpleProductTypePriceConfigSection.title")); //$NON-NLS-1$
	}
