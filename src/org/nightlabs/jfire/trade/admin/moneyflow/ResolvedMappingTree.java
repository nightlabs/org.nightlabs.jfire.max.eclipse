...
{	
	...
	{
		monitor.beginTask(Messages.getString("org.nightlabs.jfire.trade.admin.moneyflow.ResolvedMappingTree.loadMoneyFlowMappingMonitor.task.name"), 2); //$NON-NLS-1$
		monitor.worked(1);
...
//							return account.getName().getText(Locale.getDefault().getLanguage());
	...
	public void createTreeColumns(Tree tree) {
		...
		column.setText(Messages.getString("org.nightlabs.jfire.trade.admin.moneyflow.ResolvedMappingTree.ProductTypeMappingTreeColumn.text")); //$NON-NLS-1$
		...
		column = new TreeColumn(getTree(), SWT.LEFT);
		column.setText(Messages.getString("org.nightlabs.jfire.trade.admin.moneyflow.ResolvedMappingTree.contributingDelegateTreeColumn.text")); //$NON-NLS-1$
		column.setResizable(true);
	...
	public void setProductTypeID(final ProductTypeID productTypeID, ProgressMonitor monitor) {
		...
		Job job = new Job(Messages.getString("org.nightlabs.jfire.trade.admin.moneyflow.ResolvedMappingTree.loadMoneyFlowMappingJob.name")){ //$NON-NLS-1$
			@Override
