		...
		extends EntityEditorPageWithProgress
{
	...
	{
		super(editor, ProductTransferPage.class.getName(), Messages.getString("org.nightlabs.jfire.trade.repository.editor.ProductTransferPage.title")); // this is shown in the tab on the bottom //$NON-NLS-1$
	}
	...
	{
		return Messages.getString("org.nightlabs.jfire.trade.repository.editor.ProductTransferPage.title"); //$NON-NLS-1$
	}
