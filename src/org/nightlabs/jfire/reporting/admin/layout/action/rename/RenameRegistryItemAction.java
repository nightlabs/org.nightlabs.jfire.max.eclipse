...
public class RenameRegistryItemAction extends ReportRegistryItemAction {
	 ...
	 * @param text
	 */
	public RenameRegistryItemAction(String text) {
		super(text);
	}
	 ...
	 * @param image
	 */
	public RenameRegistryItemAction(String text, ImageDescriptor image) {
		super(text, image);
	}
	 ...
	 * @param style
	 */
	public RenameRegistryItemAction(String text, int style) {
		super(text, style);
	}
