...
package org.nightlabs.jfire.scripting.admin.script.action;
...
public abstract class ScriptRegistryItemAction extends Action implements IScriptRegistryItemAction {
	...
	/*
	 *  (non-Javadoc)
	 * @see org.nightlabs.jfire.scripting.admin.script.action.IScriptRegistryItemAction#setScriptRegistryItems(java.util.Collection)
	 */
	...
	/*
	 *  (non-Javadoc)
	 * @see org.nightlabs.jfire.scripting.admin.script.action.IScriptRegistryItemAction#getScriptRegistryItems()
	 */
	...
	/*
	 *  (non-Javadoc)
	 * @see org.nightlabs.jfire.scripting.admin.script.action.IScriptRegistryItemAction#calculateEnabled(java.util.Collection)
	 */
	...
	/*
	 *  (non-Javadoc)
	 * @see org.nightlabs.jfire.scripting.admin.script.action.IScriptRegistryItemAction#calculateVisible(java.util.Collection)
	 */
