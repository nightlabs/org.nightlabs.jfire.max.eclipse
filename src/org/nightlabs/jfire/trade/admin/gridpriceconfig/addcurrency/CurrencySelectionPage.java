...
package org.nightlabs.jfire.trade.admin.gridpriceconfig.addcurrency;
...
public class CurrencySelectionPage extends DynamicPathWizardPage
{
	...
	{
		super(CurrencySelectionPage.class.getName(), Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.addcurrency.CurrencySelectionPage.title")); //$NON-NLS-1$
		setDescription(Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.addcurrency.CurrencySelectionPage.description")); //$NON-NLS-1$
	}
	...
	public Control createPageContents(Composite parent)
	{
		...
		currencyList.add(Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.addcurrency.CurrencySelectionPage.pseudoEntry_loading")); //$NON-NLS-1$
		Job loadJob = new Job(Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.addcurrency.CurrencySelectionPage.loadCurrenciesJob.name")) { //$NON-NLS-1$
			@Override
