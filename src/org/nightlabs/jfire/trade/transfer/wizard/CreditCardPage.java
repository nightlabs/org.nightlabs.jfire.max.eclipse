...
import org.nightlabs.jfire.trade.transfer.pay.ClientPaymentProcessorCreditCardBackend;
...
public class CreditCardPage extends WizardHopPage
{
	...
	{
		super(CreditCardPage.class.getName(), Messages.getString("org.nightlabs.jfire.trade.transfer.wizard.CreditCardPage.title")); //$NON-NLS-1$
		this.clientPaymentProcessor = clientPaymentProcessorCreditCard;
		setMessage(null);
		setDescription(Messages.getString("org.nightlabs.jfire.trade.transfer.wizard.CreditCardPage.description")); //$NON-NLS-1$
	}
...
// end test stuff
		...
		(nameOnCardLabel = new Label(page, SWT.NONE)).setText(Messages.getString("org.nightlabs.jfire.trade.transfer.wizard.CreditCardPage.nameLabel.text")); //$NON-NLS-1$
...
//		});
		...
		(cardNumberLabel = new Label(page, SWT.NONE)).setText(Messages.getString("org.nightlabs.jfire.trade.transfer.wizard.CreditCardPage.cardNumberLabel.text")); //$NON-NLS-1$
		cardNumberLabel.setToolTipText(Messages.getString("org.nightlabs.jfire.trade.transfer.wizard.CreditCardPage.cardNumberLabel.toolTipText")); //$NON-NLS-1$
		...
		(cvcLabel = new Label(page, SWT.NONE)).setText(Messages.getString("org.nightlabs.jfire.trade.transfer.wizard.CreditCardPage.cvcLabel.text")); //$NON-NLS-1$
		cvcLabel.setToolTipText(Messages.getString("org.nightlabs.jfire.trade.transfer.wizard.CreditCardPage.cvcLabel.toolTipText")); //$NON-NLS-1$
		...
		(expiryLabel = new Label(page, SWT.NONE)).setText(Messages.getString("org.nightlabs.jfire.trade.transfer.wizard.CreditCardPage.expiryLabel.text")); //$NON-NLS-1$
		expiryLabel.setToolTipText(Messages.getString("org.nightlabs.jfire.trade.transfer.wizard.CreditCardPage.expiryLabel.toolTipText")); //$NON-NLS-1$
