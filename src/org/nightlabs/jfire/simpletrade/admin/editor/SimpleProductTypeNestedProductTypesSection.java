...
import org.nightlabs.jfire.simpletrade.admin.producttype.nestedproducttype.CreateNestedProductTypeWizard;
...
extends AbstractNestedProductTypeSection
{
			...
			Composite parent, int style) 
	{
		super(
				page, parent, style,
				Messages.getString("org.nightlabs.jfire.simpletrade.admin.editor.SimpleProductTypeNestedProductTypesSection.title")); //$NON-NLS-1$
	}
