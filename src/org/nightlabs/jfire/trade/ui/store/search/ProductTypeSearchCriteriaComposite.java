...
//		parent.setLayout(new RowLayout());
		...
		createTextComposite(parent, Messages.getString("org.nightlabs.jfire.trade.ui.store.search.ProductTypeSearchCriteriaComposite.deliveryConfigurationGroup.text"), deliveryConfigurationListener); //$NON-NLS-1$
		createTextComposite(parent, Messages.getString("org.nightlabs.jfire.trade.ui.store.search.ProductTypeSearchCriteriaComposite.priceConfigurationGroup.text"), innerPriceConfigListener); //$NON-NLS-1$
		createTextComposite(parent, Messages.getString("org.nightlabs.jfire.trade.ui.store.search.ProductTypeSearchCriteriaComposite.accountConfigurationGroup.text"), localAccountDelegateListener); //$NON-NLS-1$
		createTextComposite(parent, Messages.getString("org.nightlabs.jfire.trade.ui.store.search.ProductTypeSearchCriteriaComposite.ownerGroup.text"), ownerListener); //$NON-NLS-1$
		createTextComposite(parent, Messages.getString("org.nightlabs.jfire.trade.ui.store.search.ProductTypeSearchCriteriaComposite.productTypeGroupGroup.text"), productTypeGroupListener);		 //$NON-NLS-1$
	}
