...
public class ReportParameterAcquisitionUseCaseWizardPage extends WizardHopPage {
	...
	public ReportParameterAcquisitionUseCaseWizardPage(String pageName, ReportRegistryItemID reportLayoutID) {
		super(pageName);
		setTitle(Messages.getString("org.nightlabs.jfire.reporting.parameter.eportParameterAcquisitionUseCaseWizardPage.title")); //$NON-NLS-1$
		setDescription(Messages.getString("org.nightlabs.jfire.reporting.parameter.eportParameterAcquisitionUseCaseWizardPage.description")); //$NON-NLS-1$
		init(reportLayoutID);
	}
		...
		) 
	{
		...
		for (SortedMap<Integer, ValueProviderConfig> providerPageConfigs : sortedConfigs.values()) {
			ReportParameterValueProviderWizardPage page = new ReportParameterValueProviderWizardPage(
					Messages.getString("org.nightlabs.jfire.reporting.parameter.eportParameterAcquisitionUseCaseWizardPage.pagePrefix")+(++i),  //$NON-NLS-1$
