...
import org.nightlabs.jfire.trade.admin.moneyflow.edit.AddMoneyFlowMappingWizard;
import org.nightlabs.jfire.trade.admin.moneyflow.edit.SelectCreateAccountantDelegateWizard;
...
{	
	...
	private NotificationListener notificationListenerProductTypeSelected = new NotificationAdapterJob(Messages.getString("org.nightlabs.jfire.trade.admin.moneyflow.MoneyFlowConfigComposite.loadMoneyFlowConfigJob.name")) {		 //$NON-NLS-1$
	...
	{
		currProductTypeID = productTypeID;
		Job updateJob = new FadeableCompositeJob(Messages.getString("org.nightlabs.jfire.trade.admin.moneyflow.MoneyFlowConfigComposite.updateMoneyFlowConfigJob.name"), fadeableComposite, this) { //$NON-NLS-1$
	...
	public void createPartContents(Composite parent) 
	{
		...
		if (showButtons) {
			...
			addDelegateButton.setText(Messages.getString("org.nightlabs.jfire.trade.admin.moneyflow.MoneyFlowConfigComposite.addDelegateButton.text")); //$NON-NLS-1$
			...
			removeDelegateButton.setText(Messages.getString("org.nightlabs.jfire.trade.admin.moneyflow.MoneyFlowConfigComposite.removeDelegateButton.text")); //$NON-NLS-1$
		...
		label.setText(Messages.getString("org.nightlabs.jfire.trade.admin.moneyflow.MoneyFlowConfigComposite.noDelegateLabel.text")); //$NON-NLS-1$
		Button button = new Button(noDelegateComp, SWT.FLAT);
		button.setText(Messages.getString("org.nightlabs.jfire.trade.admin.moneyflow.MoneyFlowConfigComposite.assignDelegateButton.text")); //$NON-NLS-1$
	...
	/**
	 * @see org.nightlabs.jfire.trade.admin.moneyflow.MoneyFlowMappingTree#setLastAddedMapping(org.nightlabs.jfire.accounting.book.MoneyFlowMapping)
	 */
	...
	/**
	 * @see org.nightlabs.jfire.trade.admin.moneyflow.MoneyFlowMappingTree#getSelectedLocalAccountantDelegate()
	 */
	...
	/**
	 * @see org.nightlabs.jfire.trade.admin.moneyflow.MoneyFlowMappingTree#getSelectedMoneyFlowMapping()
	 */
