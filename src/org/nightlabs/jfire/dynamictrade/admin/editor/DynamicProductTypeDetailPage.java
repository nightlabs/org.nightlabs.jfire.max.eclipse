...
extends AbstractProductTypeDetailPage 
{
	...
	public DynamicProductTypeDetailPage(FormEditor editor) {
		super(editor, DynamicProductTypeDetailPage.class.getName(), Messages.getString("org.nightlabs.jfire.dynamictrade.admin.editor.DynamicProductTypeDetailPage.title")); //$NON-NLS-1$
	}
