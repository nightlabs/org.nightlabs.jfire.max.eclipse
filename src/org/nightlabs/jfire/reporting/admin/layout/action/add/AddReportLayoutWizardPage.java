...
package org.nightlabs.jfire.reporting.admin.layout.action.add;
...
public class AddReportLayoutWizardPage extends I18nTextEditorWizardPage {
	...
	public AddReportLayoutWizardPage() {
		super(AddReportLayoutWizardPage.class.getName(), Messages.getString("org.nightlabs.jfire.reporting.admin.layout.action.add.AddReportLayoutWizardPage.title"), Messages.getString("org.nightlabs.jfire.reporting.admin.layout.action.add.AddReportLayoutWizardPage.editorCaption")); //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	protected void createAdditionalContents(Composite wrapper) {
		registryItemID = new LabeledText(wrapper, Messages.getString("org.nightlabs.jfire.reporting.admin.layout.action.add.AddReportLayoutWizardPage.registryItemIDLabel.text")); //$NON-NLS-1$
		choice = new Group(wrapper, SWT.NONE);
		choice.setText(Messages.getString("org.nightlabs.jfire.reporting.admin.layout.action.add.AddReportLayoutWizardPage.creationStyleGroup")); //$NON-NLS-1$
		...
		reportFromFile.setText(Messages.getString("org.nightlabs.jfire.reporting.admin.layout.action.add.AddReportLayoutWizardPage.reportFromFileButton.text")); //$NON-NLS-1$
		reportFromFile.setLayoutData(new GridData());
		reportFromTemplate = new Button(choice, SWT.RADIO);
		reportFromTemplate.setText(Messages.getString("org.nightlabs.jfire.reporting.admin.layout.action.add.AddReportLayoutWizardPage.reportFromTemplateButton.text")); //$NON-NLS-1$
		...
		fileSelectComposite = new FileSelectionComposite(wrapper, SWT.NONE, 
				...
				Messages.getString("org.nightlabs.jfire.reporting.admin.layout.action.add.AddReportLayoutWizardPage.fileSelectComposite.caption"),  //$NON-NLS-1$ 
				null) 
		{
			@Override
