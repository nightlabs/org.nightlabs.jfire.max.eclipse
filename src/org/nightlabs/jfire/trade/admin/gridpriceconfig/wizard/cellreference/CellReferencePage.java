...
public class CellReferencePage extends AbstractCellReferencePage{
	...
	protected List<Composite> createDimensionTabItems(TabFolder tabFolder) {
		...
		customerGroupTabItem.setText(Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.wizard.cellreference.CellReferencePage.customerGroupTabItem.text")); //$NON-NLS-1$
		...
		tariffTabItem.setText(Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.wizard.cellreference.CellReferencePage.tariffTabItem.text")); //$NON-NLS-1$
		...
		currencyTabItem.setText(Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.wizard.cellreference.CellReferencePage.currencyTabItem.text")); //$NON-NLS-1$
		...
		if (pc.getCellReferenceProductTypeSelector() == null)
			...
			productTypeTabItem.setText(Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.wizard.cellreference.CellReferencePage.productTypeTabItem.text")); //$NON-NLS-1$
		...
		priceFragmentTabItem.setText(Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.wizard.cellreference.CellReferencePage.priceFragmentTypeTabItem.text")); //$NON-NLS-1$
