...
extends AbstractPropertySource 
{
	...
	protected IPropertyDescriptor createProviderPD() 
	{
		PropertyDescriptor pd = new XTextPropertyDescriptor(
				...
				Messages.getString("org.nightlabs.jfire.reporting.admin.parameter.property.ValueConsumerBindingPropertySource.propertyDescriptorProvider.name"), true); //$NON-NLS-1$
		return pd;
	}
	...
	protected IPropertyDescriptor createConsumerPD() 
	{
		PropertyDescriptor pd = new XTextPropertyDescriptor(
				...
				Messages.getString("org.nightlabs.jfire.reporting.admin.parameter.property.ValueConsumerBindingPropertySource.propertyDescriptorConsumer.name"), true); //$NON-NLS-1$
		return pd;
	}
