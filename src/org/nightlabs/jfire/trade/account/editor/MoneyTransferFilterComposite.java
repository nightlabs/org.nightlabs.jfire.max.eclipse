...
public class MoneyTransferFilterComposite extends XComposite
{
	...
	protected void createComposite(Composite parent) 
	{
		...
		transferAmountEntry = new SpinnerSearchEntry(parent, SWT.NONE, Messages.getString("org.nightlabs.jfire.trade.overview.account.AccountSearchComposite.minBalanceEntry.caption")); //$NON-NLS-1$
		...
		dateGroup.setText(Messages.getString("org.nightlabs.jfire.trade.account.editor.ManualMoneyTransferSearchComposite.dateGroup.text")); //$NON-NLS-1$
		...
		createDTMin = new DateTimeEdit(
				...
				Messages.getString("org.nightlabs.jfire.trade.overview.StatableFilterComposite.createDateMin.caption")); //$NON-NLS-1$
		...
		createDTMax = new DateTimeEdit(
				dateGroup,
				DateFormatter.FLAGS_DATE_SHORT_TIME_HMS_WEEKDAY + DateTimeEdit.FLAGS_SHOW_ACTIVE_CHECK_BOX,
				Messages.getString("org.nightlabs.jfire.trade.overview.StatableFilterComposite.createDateMax.caption"));		 //$NON-NLS-1$
		...
		otherSideAccountGroup.setText(Messages.getString("org.nightlabs.jfire.trade.account.editor.ManualMoneyTransferSearchComposite.otherSideAccountGroup.text")); //$NON-NLS-1$
		otherSideAccountGroup.setLayout(new GridLayout(1, false));
		
		activeAccountButton = new Button(otherSideAccountGroup, SWT.CHECK);
		activeAccountButton.setText(Messages.getString("org.nightlabs.jfire.trade.overview.account.AccountSearchComposite.activeCurrencyButton.text")); //$NON-NLS-1$
		...
		Job job = new Job(Messages.getString("org.nightlabs.jfire.trade.account.editor.ManualMoneyTransferSearchComposite.loadingAccountsJob.name")) { //$NON-NLS-1$
			@Implement
