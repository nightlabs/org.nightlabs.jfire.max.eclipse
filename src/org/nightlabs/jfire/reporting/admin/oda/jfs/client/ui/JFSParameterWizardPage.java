...
public class JFSParameterWizardPage extends DataSetWizardPage implements ICellModifier {
	...
	private class Table extends AbstractTableComposite<ParameterDescriptor> {
		...
		protected void createTableColumns(TableViewer tableViewer, org.eclipse.swt.widgets.Table table) {
			...
			tc.setText(Messages.getString("org.nightlabs.jfire.reporting.admin.oda.jfs.client.ui.JFSParameterWizardPage.nameColumn.text")); //$NON-NLS-1$

			tc = new TableColumn(table, SWT.LEFT);
			tc.setText(Messages.getString("org.nightlabs.jfire.reporting.admin.oda.jfs.client.ui.JFSParameterWizardPage.typeColumn.text")); //$NON-NLS-1$

			tc = new TableColumn(table, SWT.LEFT);
			tc.setText(Messages.getString("org.nightlabs.jfire.reporting.admin.oda.jfs.client.ui.JFSParameterWizardPage.defaultValueColumn.text")); //$NON-NLS-1$
