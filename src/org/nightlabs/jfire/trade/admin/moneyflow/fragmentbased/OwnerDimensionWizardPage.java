...
implements MappingDimensionWizardPage
{
	...
	public OwnerDimensionWizardPage(String quickSearchText) {
		super(Messages.getString("org.nightlabs.jfire.trade.admin.moneyflow.fragmentbased.OwnerDimensionWizardPage.title"), quickSearchText);		 //$NON-NLS-1$
	}
	...
	public Control createPageContents(Composite parent) {
		...
		allOwnerButton.setText(Messages.getString("org.nightlabs.jfire.trade.admin.moneyflow.fragmentbased.OwnerDimensionWizardPage.allOwnerButton.text")); //$NON-NLS-1$
