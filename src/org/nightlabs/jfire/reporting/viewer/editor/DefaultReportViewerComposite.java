 ...
 * 
 */
package org.nightlabs.jfire.reporting.viewer.editor;
...
import org.nightlabs.jfire.reporting.config.DefaultReportViewerCfMod;
...
public class DefaultReportViewerComposite extends XComposite {
	...
	public DefaultReportViewerComposite(Composite parent, int style) {
		...
		label.setText(Messages.getString("org.nightlabs.jfire.reporting.viewer.editor.DefaultReportViewerComposite.label.text")); //$NON-NLS-1$
...
//			frame.setVisible(true);
	...
	public void showReport(final RenderReportRequest renderRequest) {
		switchToStatus();
		Job fetchJob = new Job(Messages.getString("org.nightlabs.jfire.reporting.viewer.editor.DefaultReportViewerComposite.fetchJob.name")) { //$NON-NLS-1$
			@Override
...
//		stack.layout(true, true);
		...
		if (preparedLayout.getRenderedReportLayout().getHeader().hasRenderingErrors()) {
			...
			errorLink.setText(Messages.getString("org.nightlabs.jfire.reporting.viewer.editor.DefaultReportViewerComposite.errorLink.text")); //$NON-NLS-1$
