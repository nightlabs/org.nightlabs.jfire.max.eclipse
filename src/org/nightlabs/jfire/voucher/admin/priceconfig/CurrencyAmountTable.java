		...
		public void modify(Object element, String property, Object value)
		{
			...
			if (COLUMN_AMOUNT.equals(property)) {
				...
				try {
					...
					MessageDialog.openError(getShell(), Messages.getString("org.nightlabs.jfire.voucher.admin.priceconfig.CurrencyAmountTable.errorMessageInvalidNumber.title"), Messages.getString("org.nightlabs.jfire.voucher.admin.priceconfig.CurrencyAmountTable.errorMessageInvalidNumber.message")); //$NON-NLS-1$ //$NON-NLS-2$
				}
				if (v != null) {
					me.setValue(v);
...
//		});
		...
		new TableColumn(table, SWT.LEFT).setText(Messages.getString("org.nightlabs.jfire.voucher.admin.priceconfig.CurrencyAmountTable.currencyTableColumn.text")); //$NON-NLS-1$
		new TableColumn(table, SWT.LEFT).setText(Messages.getString("org.nightlabs.jfire.voucher.admin.priceconfig.CurrencyAmountTable.amountTableColumn.text")); //$NON-NLS-1$
		...
		if (showButtons) {
			...
			addCurrencyButton.setText(Messages.getString("org.nightlabs.jfire.voucher.admin.priceconfig.CurrencyAmountTable.addCurrencyButton.text")); //$NON-NLS-1$
			...
			removeCurrencyButton.setText(Messages.getString("org.nightlabs.jfire.voucher.admin.priceconfig.CurrencyAmountTable.removeCurrencyButton.text")); //$NON-NLS-1$
