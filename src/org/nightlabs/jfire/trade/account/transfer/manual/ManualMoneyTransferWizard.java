...
public class ManualMoneyTransferWizard extends DynamicPathWizard{
	...
	public ManualMoneyTransferWizard(AnchorID selectedAccountAnchorID){
		setWindowTitle(Messages.getString("org.nightlabs.jfire.trade.account.transfer.manual.ManualMoneyTransferWizard.windowTitle")); //$NON-NLS-1$
	...
	public void addPages() {
		if(selectedAccountAnchorID == null){
			...
			fromAccountChooserPage.setTitle(Messages.getString("org.nightlabs.jfire.trade.account.transfer.manual.ManualMoneyTransferWizard.fromAccountChooserPage.title")); //$NON-NLS-1$
		...
		toAccountChooserPage.setTitle(Messages.getString("org.nightlabs.jfire.trade.account.transfer.manual.ManualMoneyTransferWizard.toAccountChooserPageTitle")); //$NON-NLS-1$
