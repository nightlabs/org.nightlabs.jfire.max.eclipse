		...
		extends WizardHopPage
{
	...
	{
		super(OrganisationSelectionPage.class.getName(), Messages.getString("org.nightlabs.jfire.simpletrade.admin.producttype.subscribe.OrganisationSelectionPage.title")); //$NON-NLS-1$
		setDescription(Messages.getString("org.nightlabs.jfire.simpletrade.admin.producttype.subscribe.OrganisationSelectionPage.description")); //$NON-NLS-1$
	}
