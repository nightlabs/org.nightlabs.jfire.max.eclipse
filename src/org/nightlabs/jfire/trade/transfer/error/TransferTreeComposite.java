...
extends AbstractTreeComposite
{
	...
	public void createTreeColumns(Tree tree)
	{
		...
		tc.setText(Messages.getString("org.nightlabs.jfire.trade.transfer.error.TransferTreeComposite.typeOrPhaseTableColumn.text")); //$NON-NLS-1$

		tc = new TreeColumn(tree, SWT.LEFT);
		tc.setText(Messages.getString("org.nightlabs.jfire.trade.transfer.error.TransferTreeComposite.amountOrResultStateTableColumn.text")); //$NON-NLS-1$

		tc = new TreeColumn(tree, SWT.LEFT);
		tc.setText(Messages.getString("org.nightlabs.jfire.trade.transfer.error.TransferTreeComposite.totalStateTableColumn.text")); //$NON-NLS-1$

		tc = new TreeColumn(tree, SWT.LEFT);
		tc.setText(Messages.getString("org.nightlabs.jfire.trade.transfer.error.TransferTreeComposite.rollbackOrErrorMessageTableColumn.text")); //$NON-NLS-1$
