		...
		extends DynamicPathWizardPage
{
	...
	{
		super(SelectProductTypePage.class.getName(), Messages.getString("org.nightlabs.jfire.simpletrade.admin.producttype.nestedproducttype.SelectProductTypePage.title"), null); //$NON-NLS-1$
		setDescription(Messages.getString("org.nightlabs.jfire.simpletrade.admin.producttype.nestedproducttype.SelectProductTypePage.description")); //$NON-NLS-1$
	}
