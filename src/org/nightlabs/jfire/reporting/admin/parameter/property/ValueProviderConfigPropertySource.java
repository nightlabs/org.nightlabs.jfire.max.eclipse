...
//}
	...
	protected PropertyDescriptor createNamePD(boolean readOnly)
	{
		PropertyDescriptor desc = new XTextPropertyDescriptor(
				...
				Messages.getString("org.nightlabs.jfire.reporting.admin.parameter.property.ValueProviderConfigPropertySource.propertyDescriptorName.name"), //$NON-NLS-1$
				readOnly);
	...
	protected PropertyDescriptor createDescriptionPD(boolean readOnly)
	{
		PropertyDescriptor desc = new XTextPropertyDescriptor(
				...
				Messages.getString("org.nightlabs.jfire.reporting.admin.parameter.property.ValueProviderConfigPropertySource.propertyDescriptorDescription.name"), //$NON-NLS-1$
				readOnly);
		desc.setCategory(CATEGORY_NAME);
		return desc;
	}
...
//		PropertyDescriptor desc = new XTextPropertyDescriptor(
		PropertyDescriptor desc = new XI18nTextPropertyDescriptor(
				...
				Messages.getString("org.nightlabs.jfire.reporting.admin.parameter.property.ValueProviderConfigPropertySource.propertyDescriptorMessage.name"), //$NON-NLS-1$
				readOnly);
		desc.setCategory(CATEGORY_NAME);
		return desc;
	}	
	
	public static final String CATEGORY_PAGE = Messages.getString("org.nightlabs.jfire.reporting.admin.parameter.property.ValueProviderConfigPropertySource.propertyDescriptorCategoryPage.name"); //$NON-NLS-1$
	...
	protected PropertyDescriptor createPageIndexPD() 
	{
		PropertyDescriptor desc = new IntPropertyDescriptor(
				...
				Messages.getString("org.nightlabs.jfire.reporting.admin.parameter.property.ValueProviderConfigPropertySource.propertyDescriptorPageIndex.name"), //$NON-NLS-1$
				false);
	...
	protected PropertyDescriptor createPageOrderPD() 
	{
		PropertyDescriptor desc = new IntPropertyDescriptor(
				...
				Messages.getString("org.nightlabs.jfire.reporting.admin.parameter.property.ValueProviderConfigPropertySource.propertyDescriptorOrder.name"), //$NON-NLS-1$
				false);
		desc.setCategory(CATEGORY_PAGE);
		return desc;		
	}	
	...
	protected PropertyDescriptor createOutputTypePD() 
	{
		PropertyDescriptor pd = new XTextPropertyDescriptor(
				...
				Messages.getString("org.nightlabs.jfire.reporting.admin.parameter.property.ValueProviderConfigPropertySource.propertyDescriptorOutputType.name"), //$NON-NLS-1$
				true);
		return pd;
	}
	...
	protected PropertyDescriptor createAllowOutputNullPD() 
	{
		...
		PropertyDescriptor pd = new CheckboxPropertyDescriptor(
				...
				Messages.getString("org.nightlabs.jfire.reporting.admin.parameter.property.ValueProviderConfigPropertySource.propertyDescriptorAllowNull.name"), false //$NON-NLS-1$
			);
		return pd;
	}
	...
	protected PropertyDescriptor createShowMessageInHeaderPD() 
	{
		...
		PropertyDescriptor pd = new CheckboxPropertyDescriptor(
				...
				Messages.getString("org.nightlabs.jfire.reporting.admin.parameter.property.ValueProviderConfigPropertySource.propertyDescriptorShowMessage.name"), false //$NON-NLS-1$
			);
		pd.setCategory(Messages.getString("org.nightlabs.jfire.reporting.admin.parameter.property.ValueProviderConfigPropertySource.propertyDescriptorCategoryName.name")); //$NON-NLS-1$
		return pd;
	}
