...
public class OfferSegmentComposite extends XComposite
{
	...
	public OfferSegmentComposite(Composite parent, OfferSegmentEdit _orderSegmentEdit)
	{
		...
		articleAdderPlaceholderLabel.setText(Messages.getString("org.nightlabs.jfire.trade.articlecontainer.detail.offer.OfferSegmentComposite.articleAdderPlaceholderLabel.text")); //$NON-NLS-1$
