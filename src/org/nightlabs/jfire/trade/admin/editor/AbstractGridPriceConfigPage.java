...
//					}
					...
					if (productType.isClosed()) {
						priceConfigSection.setMessage(
								Messages.getString("org.nightlabs.jfire.trade.admin.editor.AbstractGridPriceConfigPage.priceConfigSection.message_productTypeClosed"), //$NON-NLS-1$
...
//		}		
	...
	protected String getPageFormTitle() {
		return Messages.getString("org.nightlabs.jfire.trade.admin.editor.AbstractGridPriceConfigPage.pageFormTitle"); //$NON-NLS-1$
	}
