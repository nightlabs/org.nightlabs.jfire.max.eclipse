...
//	private List scriptStringList = new ArrayList();
	...
	public AbstractCellReferencePage(SourceViewer sourceViewer, PriceConfigComposite priceConfigComposite){
		...
		setTitle(Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.wizard.cellreference.AbstractCellReferencePage.title")); //$NON-NLS-1$
		setDescription(Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.wizard.cellreference.AbstractCellReferencePage.description")); //$NON-NLS-1$
	}
...
//		createOverviewTabItem(tabFolder);
		...
		scriptPreviewGroup.setText(Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.wizard.cellreference.AbstractCellReferencePage.scriptPreviewGroup.text")); //$NON-NLS-1$
