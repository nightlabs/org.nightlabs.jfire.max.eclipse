...
extends CenteredDialog 
{
	...
	protected void configureShell(Shell newShell) 
	{
		...
		newShell.setText(Messages.getString("org.nightlabs.jfire.scripting.editor2d.dialog.CreateBarcodeDialog.title")); //$NON-NLS-1$
	...
	protected Control createDialogArea(Composite parent) 
	{
		...
		scriptLabel.setText(Messages.getString("org.nightlabs.jfire.scripting.editor2d.dialog.CreateBarcodeDialog.label.script")); //$NON-NLS-1$
...
//		scriptCombo.selectElement(ScriptingConstants.OID.SCRIPT_REGISTRY_ITEM_ID_SCRIPT_TICKET_KEY);
		...
		barcodeTypeLabel.setText(Messages.getString("org.nightlabs.jfire.scripting.editor2d.dialog.CreateBarcodeDialog.label.barcodeType")); //$NON-NLS-1$
		createBarcodeTypeCombo(comp);
		barcodeTypeCombo.selectElement(Type.TYPE_128);
		
		// Width scale
		Label widthScaleLabel = new Label(comp, SWT.NONE);
		widthScaleLabel.setText(Messages.getString("org.nightlabs.jfire.scripting.editor2d.dialog.CreateBarcodeDialog.label.widthScale")); //$NON-NLS-1$
		createWidthScaleCombo(comp);
		widthScaleCombo.selectElement(WidthScale.SCALE_3);
		
		// X
		Label xLabel = new Label(comp, SWT.NONE);
		xLabel.setText(Messages.getString("org.nightlabs.jfire.scripting.editor2d.dialog.CreateBarcodeDialog.label.x")); //$NON-NLS-1$
		...
		yLabel.setText(Messages.getString("org.nightlabs.jfire.scripting.editor2d.dialog.CreateBarcodeDialog.label.y")); //$NON-NLS-1$
		...
		heightLabel.setText(Messages.getString("org.nightlabs.jfire.scripting.editor2d.dialog.CreateBarcodeDialog.label.height")); //$NON-NLS-1$
		...
		orientationLabel.setText(Messages.getString("org.nightlabs.jfire.scripting.editor2d.dialog.CreateBarcodeDialog.label.orientation")); //$NON-NLS-1$
		...
		humanReadableLabel.setText(Messages.getString("org.nightlabs.jfire.scripting.editor2d.dialog.CreateBarcodeDialog.label.humanReadable")); //$NON-NLS-1$
	...
	{	
		public String getText(Object element) 
		{
			if (element instanceof Type) 
			{
				...
				{
					case TYPE_128:					
						return Messages.getString("org.nightlabs.jfire.scripting.editor2d.dialog.CreateBarcodeDialog.type128");							 //$NON-NLS-1$
				}
				return type.name();
			}
			return null;
	...
	{	
		public String getText(Object element) 
		{
			if (element instanceof WidthScale) {
				...
				{
					case SCALE_1:					
						return Messages.getString("org.nightlabs.jfire.scripting.editor2d.dialog.CreateBarcodeDialog.widthScale1");								 //$NON-NLS-1$
					case SCALE_2:
						return Messages.getString("org.nightlabs.jfire.scripting.editor2d.dialog.CreateBarcodeDialog.widthScale2"); //$NON-NLS-1$
					case SCALE_3:					
						return Messages.getString("org.nightlabs.jfire.scripting.editor2d.dialog.CreateBarcodeDialog.widthScale3"); //$NON-NLS-1$
					case SCALE_4:					
						return Messages.getString("org.nightlabs.jfire.scripting.editor2d.dialog.CreateBarcodeDialog.widthScale4"); //$NON-NLS-1$
				}
			}
			return null;
		}	
		...
		public String getText(Object element) 
		{
			if (element instanceof Orientation) {
				...
				if (orientation == Orientation.HORIZONTAL)
					return Messages.getString("org.nightlabs.jfire.scripting.editor2d.dialog.CreateBarcodeDialog.horizontal"); //$NON-NLS-1$
				if (orientation == Orientation.VERTICAL)
					return Messages.getString("org.nightlabs.jfire.scripting.editor2d.dialog.CreateBarcodeDialog.vertical");					 //$NON-NLS-1$
			}
			return null;
		}	
		public Image getImage(Object element) {
