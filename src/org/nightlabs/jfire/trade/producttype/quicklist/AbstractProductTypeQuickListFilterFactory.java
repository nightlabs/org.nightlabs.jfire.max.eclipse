...
public abstract class AbstractProductTypeQuickListFilterFactory implements IProductTypeQuickListFilterFactory {
	...
	/**
	 * {@inheritDoc}
	 * @see org.nightlabs.jfire.trade.producttype.quicklist.IProductTypeQuickListFilterFactory#getId()
	 */
	public String getId() {
		return id;
	}
	...
	/**
	 * {@inheritDoc}
	 * @see org.nightlabs.jfire.trade.producttype.quicklist.IProductTypeQuickListFilterFactory#getIndex()
	 */
	public int getIndex() {
		return index;
	}
