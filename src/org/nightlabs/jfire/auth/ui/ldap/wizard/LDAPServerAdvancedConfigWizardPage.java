 ...
 * Used for configuring advanced {@link LDAPServer} properties: leading state and JFire-LDAP synchronization. 
 * 
...
public class LDAPServerAdvancedConfigWizardPage extends WizardHopPage{
	...
	public Control createPageContents(Composite wizardParent) {
		...
		descriptionLabel.setText(leadingSystemDescription);
		...
		syncPasswordText = new Text(parent, SWT.BORDER);
