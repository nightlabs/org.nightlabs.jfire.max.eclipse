...
//	 * in {@link org.nightlabs.jfire.trade.articlecontainer.detail.action.ArticleContainerAction}s.
//	 */
...
//	}
	 ...
	 * in {@link org.nightlabs.jfire.trade.articlecontainer.detail.action.ArticleEditAction}s.
	 */
...
//	 *		{@link org.nightlabs.jfire.trade.Order}, {@link org.nightlabs.jfire.trade.Offer}
...
//	 *		an {@link org.nightlabs.jfire.accounting.Invoice} but only a few {@link org.nightlabs.jfire.trade.Article}s,
//	 *		they can be provided instead of an <code>articleContainer</code>. The only requirement is that
//	 *		all {@link org.nightlabs.jfire.trade.Article}s have the same vendor, the same customer and the same
//	 *		currency.
//	 */
...
//
//	/**
//	 * @return Returns <code>null</code>, if a <code>Collection</code> of {@link org.nightlabs.jfire.trade.Article}s
//	 *		has been specified. Otherwise it returns an {@link org.nightlabs.jfire.trade.Order},
//	 *		{@link org.nightlabs.jfire.trade.Offer} or {@link org.nightlabs.jfire.store.DeliveryNote}.
//	 */
...
//	}
	 ...
	 *		a <code>Collection</code> of {@link org.nightlabs.jfire.trade.Article}.
	 *
