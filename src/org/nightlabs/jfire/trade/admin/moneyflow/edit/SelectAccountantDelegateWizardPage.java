...
import org.nightlabs.jfire.trade.admin.moneyflow.LocalAccountantDelegateTree;
import org.nightlabs.jfire.trade.admin.moneyflow.LocalAccountantDelegateType;
import org.nightlabs.jfire.trade.admin.moneyflow.LocalAccountantDelegateTypeCombo;
...
public class SelectAccountantDelegateWizardPage extends DynamicPathWizardPage {
	...
	public SelectAccountantDelegateWizardPage(SelectCreateAccountantDelegateWizard wizard) {
		...
		this.wizard = wizard;
		setTitle(Messages.getString("org.nightlabs.jfire.trade.admin.moneyflow.edit.SelectAccountantDelegateWizardPage.title")); //$NON-NLS-1$
		setDescription(Messages.getString("org.nightlabs.jfire.trade.admin.moneyflow.edit.SelectAccountantDelegateWizardPage.description")); //$NON-NLS-1$
	}
	...
	public Control createPageContents(Composite parent) {
		...
		chooseSelected.setText(Messages.getString("org.nightlabs.jfire.trade.admin.moneyflow.edit.SelectAccountantDelegateWizardPage.chooseButton.text")); //$NON-NLS-1$
		chooseSelected.setSelection(true);

		createNew = new Button(radioWrapper, SWT.RADIO);
		createNew.setText(Messages.getString("org.nightlabs.jfire.trade.admin.moneyflow.edit.SelectAccountantDelegateWizardPage.createButton.text")); //$NON-NLS-1$
