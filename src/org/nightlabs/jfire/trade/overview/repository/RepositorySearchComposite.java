...
extends JDOQueryComposite
{
	...
	protected void createComposite(Composite parent) 
	{
		...
		ownerGroup.setText(Messages.getString("org.nightlabs.jfire.trade.overview.repository.RepositorySearchComposite.ownerGroup.text")); //$NON-NLS-1$
		...
		ownerActiveButton.setText(Messages.getString("org.nightlabs.jfire.trade.overview.repository.RepositorySearchComposite.ownerActiveButton.text")); //$NON-NLS-1$
		...
		anchorTypeIDGroup.setText(Messages.getString("org.nightlabs.jfire.trade.overview.repository.RepositorySearchComposite.anchorTypeIdGroup.text")); //$NON-NLS-1$
		...
		anchorTypeIDActiveButton.setText(Messages.getString("org.nightlabs.jfire.trade.overview.repository.RepositorySearchComposite.anchorTypeIdActiveButton.text")); //$NON-NLS-1$
