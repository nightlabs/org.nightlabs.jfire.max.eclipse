...
public class CreateAccountantDelegateWizardPage extends DynamicPathWizardPage {
	...
	public CreateAccountantDelegateWizardPage() {
		...
		setTitle(Messages.getString("org.nightlabs.jfire.trade.admin.moneyflow.edit.CreateAccountantDelegateWizardPage.title")); //$NON-NLS-1$
		setDescription(Messages.getString("org.nightlabs.jfire.trade.admin.moneyflow.edit.CreateAccountantDelegateWizardPage.description")); //$NON-NLS-1$
	}
	...
	public Control createPageContents(Composite parent) {
		...
		delegateName = new I18nTextEditor(wrapper, Messages.getString("org.nightlabs.jfire.trade.admin.moneyflow.edit.CreateAccountantDelegateWizardPage.delegateName.caption")); //$NON-NLS-1$
