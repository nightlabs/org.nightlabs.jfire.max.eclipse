...
extends LSDViewPart
{
	...
	public void createPartContents(Composite parent)
	{
		...
		createCustomerGroupMappingButton.setText(Messages.getString("org.nightlabs.jfire.trade.admin.customergroupmapping.CustomerGroupMappingView.createCustomerGroupMappingButton.text")); //$NON-NLS-1$
		...
		removeCustomerGroupMappingButton.setText(Messages.getString("org.nightlabs.jfire.trade.admin.customergroupmapping.CustomerGroupMappingView.removeCustomerGroupMappingButton.text")); //$NON-NLS-1$
