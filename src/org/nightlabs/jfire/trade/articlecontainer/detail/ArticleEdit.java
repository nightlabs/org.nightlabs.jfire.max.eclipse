...
public interface ArticleEdit
{
	 ...
	 * @param articleCarriers A subset of the {@link org.nightlabs.jfire.trade.Article}s
	...
	/**
	 * @return Returns all {@link org.nightlabs.jfire.trade.Article}s managed by this <code>ArticleEdit</code>.
...
//	List getArticles();
	 ...
	 *		all selected {@link org.nightlabs.jfire.trade.Article}s.
	 ...
	 * {@link org.nightlabs.jfire.trade.Article}s that are not contained in the given
	 ...
	 * </p>
	 *
	 * @param articles The {@link org.nightlabs.jfire.trade.Article}s that shall be selected. Never <code>null</code>.
	 * @return Returns all {@link org.nightlabs.jfire.trade.Article}s that are unknown
	 *		to this {@link ArticleEdit}. Never return <code>null</code>.
	 */
	Set<? extends Article> setSelectedArticles(Set<? extends Article> articles);

	/**
	 * When new {@link org.nightlabs.jfire.trade.Article}s  have been created, the method
	 ...
	 * </p>
	 * @param articleCarriers The {@link org.nightlabs.jfire.trade.Article}s which need to be added.
	 *		It is OK to manipulate this collection (e.g. removing all processed articles).
	 * @return Returns those instances of {@link org.nightlabs.jfire.trade.Article} that have
...
//	 * {@link org.nightlabs.jfire.trade.Article}s that shall be removed. Therefore,
//	 * some of the articles might not be known to this <code>ArticleEdit</code> and
//	 * must be ignored.
//	 *
//	 * @param articles All instances of {@link org.nightlabs.jfire.trade.Article}
...
//	 * </p>
//	 * @param articles Instances of {@link org.nightlabs.jfire.trade.Article} that shall be removed.
...
//	void removeArticles(Set<? extends Article> articles);
	 ...
	 * of {@link org.nightlabs.jfire.trade.Article}s changes.
	 *
