...
{	
	...
	public SimpleProductTypeDetailPage(FormEditor editor) {
		super(editor, SimpleProductTypeDetailPage.class.getName(), Messages.getString("org.nightlabs.jfire.simpletrade.admin.editor.SimpleProductTypeDetailPage.title")); //$NON-NLS-1$
	}
