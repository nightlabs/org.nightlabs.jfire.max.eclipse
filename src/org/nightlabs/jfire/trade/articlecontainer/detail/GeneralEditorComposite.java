...
import org.nightlabs.jfire.trade.articlecontainer.DeliveryNoteDAO;
import org.nightlabs.jfire.trade.articlecontainer.InvoiceProvider;
import org.nightlabs.jfire.trade.articlecontainer.OfferDAO;
import org.nightlabs.jfire.trade.articlecontainer.OrderDAO;
import org.nightlabs.jfire.trade.articlecontainer.detail.action.GeneralEditorActionBarContributor;
import org.nightlabs.jfire.trade.articlecontainer.detail.deliverynote.DeliveryNoteFooterComposite;
import org.nightlabs.jfire.trade.articlecontainer.detail.deliverynote.DeliveryNoteHeaderComposite;
...
import org.nightlabs.jfire.trade.articlecontainer.detail.invoice.InvoiceFooterComposite;
import org.nightlabs.jfire.trade.articlecontainer.detail.invoice.InvoiceHeaderComposite;
import org.nightlabs.jfire.trade.articlecontainer.detail.offer.GeneralEditorInputOffer;
import org.nightlabs.jfire.trade.articlecontainer.detail.offer.OfferFooterComposite;
import org.nightlabs.jfire.trade.articlecontainer.detail.offer.OfferHeaderComposite;
import org.nightlabs.jfire.trade.articlecontainer.detail.order.GeneralEditorInputOrder;
import org.nightlabs.jfire.trade.articlecontainer.detail.order.OrderFooterComposite;
import org.nightlabs.jfire.trade.articlecontainer.detail.order.OrderHeaderComposite;
 ...
 * {@link org.nightlabs.jfire.trade.Order}s,
 * {@link org.nightlabs.jfire.trade.Offer}s,
 * {@link org.nightlabs.jfire.accounting.Invoice}s and
 * {@link org.nightlabs.jfire.store.Delivery}s. It asks the
 * {@link org.nightlabs.jfire.trade.articlecontainer.detail.SegmentEditFactoryRegistry}
 * for the right factories for all the {@link org.nightlabs.jfire.trade.Segment}s
 * and displays the edits which are delivered from the factory.
 * <p>
 * This <tt>Composite</tt> contains the main logic while
 * {@link org.nightlabs.jfire.trade.articlecontainer.detail.GeneralEditor} is
...
//				null,
	...
	private CompositeContentChangeListener segmentCompositeContentChangeListener = new CompositeContentChangeListener() {
		/**
		 * @see org.nightlabs.jfire.trade.articlecontainer.detail.CompositeContentChangeListener#changed(org.nightlabs.jfire.trade.articlecontainer.CompositeContentChangeEvent)
		 */
	...
	protected void createSegmentEditComposite(ArticleSegmentGroup asg, SegmentEdit segmentEdit) 
	{
		...
		if (hasDifferentSegments()) {
			...
			tabItem.setText(
					String.format(
							Messages.getString("org.nightlabs.jfire.trade.articlecontainer.detail.GeneralEditorComposite.segmentTabItem.text"), //$NON-NLS-1$
...
//			segmentEditComposite.layout();
	 ...
	 *         {@link org.nightlabs.jfire.trade.Order},
	 *         {@link org.nightlabs.jfire.trade.Offer},
