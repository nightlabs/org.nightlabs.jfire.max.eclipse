...
//		ProductType.FETCH_GROUP_FIELD_METADATA_MAP,
	...
	protected void addLeadingColumns() {
		TreeColumn column = new TreeColumn(getTree(), SWT.LEFT);
		column.setResizable(true);
		column.setText(Messages.getString("org.nightlabs.jfire.trade.admin.moneyflow.MoneyFlowMappingTree.productTypeTreeColumn.text")); //$NON-NLS-1$
		// TODO: Set better width
		column.setWidth(200);
		
		TreeColumn packageTypeCol = new TreeColumn(getTree(), SWT.LEFT);
		packageTypeCol.setResizable(true);
		packageTypeCol.setText(Messages.getString("org.nightlabs.jfire.trade.admin.moneyflow.MoneyFlowMappingTree.packageTypeTreeColumn.text")); //$NON-NLS-1$
		// TODO: Set better width
