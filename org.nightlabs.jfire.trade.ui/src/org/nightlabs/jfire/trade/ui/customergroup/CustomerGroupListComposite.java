...
implements ISelectionProvider
{
	...
	public void loadCustomerGroups()
	{
		...
		customerGroupList.add(Messages.getString("org.nightlabs.jfire.trade.ui.customergroup.CustomerGroupListComposite.loadCustomerGroups.pseudoEntry_loading")); //$NON-NLS-1$
