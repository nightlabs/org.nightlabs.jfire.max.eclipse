...
public class CreateTariffPage extends DynamicPathWizardPage
{
	...
	{
		super(CreateTariffPage.class.getName(), Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.addtariff.CreateTariffPage.title")); //$NON-NLS-1$
		setDescription(Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.addtariff.CreateTariffPage.description")); //$NON-NLS-1$
	}
	...
	public Control createPageContents(Composite parent)
	{
		...
		new Label(page, SWT.NONE).setText(Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.addtariff.CreateTariffPage.nameLabel.text")); //$NON-NLS-1$
