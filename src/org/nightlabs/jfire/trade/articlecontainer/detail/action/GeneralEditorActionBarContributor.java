...
import org.nightlabs.jfire.trade.TradePerspective;
import org.nightlabs.jfire.trade.articlecontainer.detail.ActiveSegmentEditSelectionEvent;
import org.nightlabs.jfire.trade.articlecontainer.detail.ActiveSegmentEditSelectionListener;
import org.nightlabs.jfire.trade.articlecontainer.detail.ArticleChangeEvent;
import org.nightlabs.jfire.trade.articlecontainer.detail.ArticleChangeListener;
import org.nightlabs.jfire.trade.articlecontainer.detail.ArticleCreateEvent;
import org.nightlabs.jfire.trade.articlecontainer.detail.ArticleCreateListener;
...
import org.nightlabs.jfire.trade.articlecontainer.detail.ClientArticleSegmentGroups;
import org.nightlabs.jfire.trade.articlecontainer.detail.CreateArticleEditEvent;
import org.nightlabs.jfire.trade.articlecontainer.detail.CreateArticleEditListener;
import org.nightlabs.jfire.trade.articlecontainer.detail.GeneralEditorComposite;
import org.nightlabs.jfire.trade.articlecontainer.detail.IGeneralEditor;
import org.nightlabs.jfire.trade.articlecontainer.detail.SegmentEdit;
import org.nightlabs.jfire.trade.articlecontainer.detail.SegmentEditArticleSelectionEvent;
import org.nightlabs.jfire.trade.articlecontainer.detail.SegmentEditArticleSelectionListener;
...
//	 This listener is subscribed to the whole ClientArticleSegmentGroups and therefore not all Articles
	...
	/**
	 * This method is called whenever the selection of {@link org.nightlabs.jfire.trade.Article}s within
...
//			throw new IllegalStateException("toolBarManager is null! Why has contributeToCoolBar(...) not been called?!");
		...
		if (localPulldownMenuManager == null) {
			...
			if (localPulldownMenuManager == null) {
				localPulldownMenuManager = new MenuManager(Messages.getString("org.nightlabs.jfire.trade.articlecontainer.detail.action.GeneralEditorActionBarContributor.pulldownMenu.text"), GeneralEditorActionBarContributor.class.getPackage().getName()); //$NON-NLS-1$
