...
class SelectTargetDeliveryQueueWizardPage extends WizardHopPage {
	...
	public SelectTargetDeliveryQueueWizardPage(List<DeliveryQueue> visibleDeliveryQueues) {
		super(SelectTargetDeliveryQueueWizardPage.class.getName(), Messages.getString("org.nightlabs.jfire.trade.transfer.deliver.SelectTargetDeliveryQueueWizardPage.title")); //$NON-NLS-1$
		setDescription(Messages.getString("org.nightlabs.jfire.trade.transfer.deliver.SelectTargetDeliveryQueueWizardPage.description")); //$NON-NLS-1$
	...
	public Control createPageContents(Composite parent) {
		...
		queueCombo = new XComboComposite<DeliveryQueue>(comp, 
				AbstractListComposite.getDefaultWidgetStyle(comp), Messages.getString("org.nightlabs.jfire.trade.transfer.deliver.SelectTargetDeliveryQueueWizardPage.queueCombo.caption"), labelProvider); //$NON-NLS-1$
