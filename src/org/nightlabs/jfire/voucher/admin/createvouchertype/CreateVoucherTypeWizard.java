...
import org.nightlabs.jfire.voucher.admin.editor.VoucherTypeEditor;
import org.nightlabs.jfire.voucher.admin.editor.VoucherTypeEditorInput;
import org.nightlabs.jfire.voucher.admin.resource.Messages;
import org.nightlabs.jfire.voucher.admin.tree.VoucherTypeTreeNode;
...
extends DynamicPathWizard
{
	...
	public boolean performFinish()
	{
		...
		Job job = new Job(Messages.getString("org.nightlabs.jfire.voucher.admin.createvouchertype.CreateVoucherTypeWizard.createVoucherTypeJob.name")) { //$NON-NLS-1$
			@Implement
