...
import org.nightlabs.jfire.trade.transfer.pay.ClientPaymentProcessor;
import org.nightlabs.jfire.trade.transfer.pay.ClientPaymentProcessorFactory;
import org.nightlabs.jfire.trade.transfer.pay.ClientPaymentProcessorFactoryRegistry;
...
//	private org.eclipse.swt.widgets.List modeOfPaymentFlavourGUIList;
	...
	{
		super(PaymentEntryPage.class.getName() + '/' + payment.getPaymentID(), Messages.getString("org.nightlabs.jfire.trade.transfer.wizard.PaymentEntryPage.title"), //$NON-NLS-1$
		...
		setDescription(Messages.getString("org.nightlabs.jfire.trade.transfer.wizard.PaymentEntryPage.description")); //$NON-NLS-1$
	...
	protected void updateAmountGUI()
	{
		...
		if (amountValueLabel != null) {
			...
			amountValueLabel.setText(
					String.format(Messages.getString("org.nightlabs.jfire.trade.transfer.wizard.PaymentEntryPage.amountValueLabel.text"), //$NON-NLS-1$
...
//			(amountTitleLabel = new Label(amountComposite, SWT.NONE)).setText("Amount to pay: ");
			...
			if (Payment.PAYMENT_DIRECTION_INCOMING.equals(getPayment().getPaymentDirection()))
				amountTitleLabel.setText(Messages.getString("org.nightlabs.jfire.trade.transfer.wizard.PaymentEntryPage.amountTitleLabel.text_receive")); //$NON-NLS-1$
...
//				amountTitleLabel.setFont(new Font(amountTitleLabel.getDisplay(), amountTitleLabel.getFont().getFontData()[0].getName(), amountTitleLabel.getFont().getFontData()[0].getHeight(), amountTitleLabel.getFont().getFontData()[0].getStyle() | SWT.BOLD));
				amountTitleLabel.setText(Messages.getString("org.nightlabs.jfire.trade.transfer.wizard.PaymentEntryPage.amountTitleLabel.text_pay")); //$NON-NLS-1$
			}
			else
			...
			(modeOfPaymentTitleLabel = new Label(page, SWT.NONE)).setText(Messages.getString("org.nightlabs.jfire.trade.transfer.wizard.PaymentEntryPage.modeOfPaymentFlavourLabel.text")); //$NON-NLS-1$
...
//			modeOfPaymentFlavourGUIList.setLayoutData(new GridData(GridData.FILL_BOTH));
			...
			spacer.getGridData().grabExcessVerticalSpace = false;
			spacer.getGridData().heightHint = 4;
			(clientPaymentProcessorFactoryLabel = new Label(page, SWT.NONE)).setText(Messages.getString("org.nightlabs.jfire.trade.transfer.wizard.PaymentEntryPage.clientPaymentProcessorFactoryLabel.text")); //$NON-NLS-1$
			...
			spacer.getGridData().grabExcessVerticalSpace = false;
			spacer.getGridData().heightHint = 4;
			(serverPaymentProcessorLabel = new Label(page, SWT.NONE)).setText(Messages.getString("org.nightlabs.jfire.trade.transfer.wizard.PaymentEntryPage.serverPaymentProcessorLabel.text")); //$NON-NLS-1$
...
//				selectedModeOfPaymentFlavour = (ModeOfPaymentFlavour) modeOfPaymentFlavourList.get(idx);
				...
				if (clientPaymentProcessorFactoryCombo.getItemCount() > 0)
					...
					setMessage(String.format(
							Messages.getString("org.nightlabs.jfire.trade.transfer.wizard.PaymentEntryPage.errorNoClientPaymentProcessorFactoryRegisteredForSelectedModeOfPaymentFlavour"), //$NON-NLS-1$
...
//		wizard.removeAllDynamicWizardPages();
		...
		if (idx >= 0) {
			...
			if (serverPaymentProcessorCombo.getItemCount() > 0)
				...
				setMessage(String.format(
						Messages.getString("org.nightlabs.jfire.trade.transfer.wizard.PaymentEntryPage.errorNoServerPaymentProcessorRegisteredForSelectedModeOfPaymentFlavour"), //$NON-NLS-1$
						selectedModeOfPaymentFlavour.getPrimaryKey(),
						selectedModeOfPaymentFlavour.getName().getText()), IMessageProvider.ERROR);
		}
