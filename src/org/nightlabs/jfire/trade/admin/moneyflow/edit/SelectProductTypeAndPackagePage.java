...
package org.nightlabs.jfire.trade.admin.moneyflow.edit;
...
public class SelectProductTypeAndPackagePage extends DynamicPathWizardPage {
	...
	public SelectProductTypeAndPackagePage(ProductTypeID productTypeID) {
		super(SelectProductTypeAndPackagePage.class.getName(), Messages.getString("org.nightlabs.jfire.trade.admin.moneyflow.edit.SelectProductTypeAndPackagePage.title"));		 //$NON-NLS-1$
	...
	public Control createPageContents(Composite parent) {
		...
		packageTypeDescriptions = new String[] {
			Messages.getString("org.nightlabs.jfire.trade.admin.moneyflow.edit.SelectProductTypeAndPackagePage.packageTypeDescription_outer"),  //$NON-NLS-1$
			Messages.getString("org.nightlabs.jfire.trade.admin.moneyflow.edit.SelectProductTypeAndPackagePage.packageTypeDescription_inner") //$NON-NLS-1$
		};
		...
		comboPackageType.add(Messages.getString("org.nightlabs.jfire.trade.admin.moneyflow.edit.SelectProductTypeAndPackagePage.comboPackageType.item_packageOuter")); //$NON-NLS-1$
		comboPackageType.add(Messages.getString("org.nightlabs.jfire.trade.admin.moneyflow.edit.SelectProductTypeAndPackagePage.comboPackageType.item_packageInner")); //$NON-NLS-1$
	...
	protected String getDefaultPageMessage() {
		return Messages.getString("org.nightlabs.jfire.trade.admin.moneyflow.edit.SelectProductTypeAndPackagePage.description"); //$NON-NLS-1$
	}
