...
//	}
	...
	protected void createTableColumns(TableViewer tableViewer, Table table)
	{
		...
		col.setText(Messages.getString("org.nightlabs.jfire.trade.admin.producttype.NestedProductTypeTable.nameTableColumn.text")); //$NON-NLS-1$
		...
		col.setText(Messages.getString("org.nightlabs.jfire.trade.admin.producttype.NestedProductTypeTable.quantityTableColumn.text")); //$NON-NLS-1$
