...
import org.nightlabs.jfire.trade.admin.gridpriceconfig.wizard.cellreference.InsertCellReferenceAction;
...
//	}
	...
	public CellDetail(Composite parent, int style, PriceConfigGrid priceConfigGrid)
	{
		...
		tabItemCell.setText(Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.CellDetail.cellTabItem.text")); //$NON-NLS-1$

		tabItemFallback = new TabItem(cellDetailFolder, SWT.NONE);
		tabItemFallback.setText(Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.CellDetail.fallbackTabItem.text")); //$NON-NLS-1$
