...
public class SelectDeliveryNotePage extends DynamicPathWizardPage
{
	...
	{
		super(SelectDeliveryNotePage.class.getName(), Messages.getString("org.nightlabs.jfire.trade.articlecontainer.detail.action.addtodeliverynote.SelectDeliveryNotePage.title")); //$NON-NLS-1$
	...
	public Control createPageContents(Composite parent)
	{
		...
		createDeliveryNoteRadio.setText(Messages.getString("org.nightlabs.jfire.trade.articlecontainer.detail.action.addtodeliverynote.SelectDeliveryNotePage.createDeliveryNoteRadio.text")); //$NON-NLS-1$
		createDeliveryNoteRadio.setSelection(true);
		selectDeliveryNoteRadio = new Button(page, SWT.RADIO);
		selectDeliveryNoteRadio.setText(Messages.getString("org.nightlabs.jfire.trade.articlecontainer.detail.action.addtodeliverynote.SelectDeliveryNotePage.selectDeliveryNoteRadio.text")); //$NON-NLS-1$
		...
		deliveryNoteTable = new AbstractTableComposite(page, SWT.NONE, true, SWT.BORDER | SWT.FULL_SELECTION | SWT.SINGLE) {
			...
			{
				new TableColumn(table, SWT.RIGHT).setText(Messages.getString("org.nightlabs.jfire.trade.articlecontainer.detail.action.addtodeliverynote.SelectDeliveryNotePage.deliveryNoteIDTableColumn.text")); //$NON-NLS-1$
				new TableColumn(table, SWT.LEFT).setText(Messages.getString("org.nightlabs.jfire.trade.articlecontainer.detail.action.addtodeliverynote.SelectDeliveryNotePage.createDateTableColumn.text")); //$NON-NLS-1$
				new TableColumn(table, SWT.LEFT).setText(Messages.getString("org.nightlabs.jfire.trade.articlecontainer.detail.action.addtodeliverynote.SelectDeliveryNotePage.createUserTableColumn.text")); //$NON-NLS-1$
		...
		deliveryNotes.add(Messages.getString("org.nightlabs.jfire.trade.articlecontainer.detail.action.addtodeliverynote.SelectDeliveryNotePage.loadDeliveryNotesPseudoEntry")); //$NON-NLS-1$
		deliveryNoteTable.setInput(deliveryNotes);
		deliveryNoteTable.setEnabled(selectDeliveryNoteRadio.getSelection());

		new Job(Messages.getString("org.nightlabs.jfire.trade.articlecontainer.detail.action.addtodeliverynote.SelectDeliveryNotePage.loadDeliveryNotesJob.name")) { //$NON-NLS-1$
