 ...
 * 
 */
package org.nightlabs.jfire.trade.overview.deliverynote.report;
...
import org.nightlabs.jfire.trade.overview.deliverynote.DeliveryNoteListComposite;
...
extends AbstractValueProviderGUI 
{
	...
	public void setInputParameterValue(String parameterID, final Object value) {
		Job loadJob = new Job(Messages.getString("org.nightlabs.jfire.trade.overview.deliverynote.report.ValueProviderGUIDeliveryNoteByCustomer.loadDeliveryNotesJob.name")) { //$NON-NLS-1$
			@Override
