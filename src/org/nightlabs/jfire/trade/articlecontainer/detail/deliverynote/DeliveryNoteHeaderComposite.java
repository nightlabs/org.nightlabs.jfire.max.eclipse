...
import org.nightlabs.jfire.trade.articlecontainer.detail.HeaderComposite;
...
extends HeaderComposite
{
	...
	private NotificationListener deliveryNoteChangedListener = new NotificationAdapterJob(Messages.getString("org.nightlabs.jfire.trade.articlecontainer.detail.deliverynote.DeliveryNoteHeaderComposite.loadDeliveryNoteJob.name")) { //$NON-NLS-1$
		public void notify(NotificationEvent notificationEvent)
		{
			ProgressMonitor monitor = getProgressMonitorWrapper();
			monitor.beginTask(Messages.getString("org.nightlabs.jfire.trade.articlecontainer.detail.deliverynote.DeliveryNoteHeaderComposite.loadDeliveryNoteMonitor.task.name"), 3); //$NON-NLS-1$
	...
	private void signalNextTransition(final SignalEvent event)
	{
		...
		Job job = new Job(Messages.getString("org.nightlabs.jfire.trade.articlecontainer.detail.deliverynote.DeliveryNoteHeaderComposite.performTransitionJob.name")) { //$NON-NLS-1$
			@Implement
