 ...
 *                                                                             *
 ******************************************************************************/
package org.nightlabs.jfire.scripting.editor2d.dialog;
...
import org.nightlabs.jfire.scripting.editor2d.AbstractScriptRegistryItemTreeComposite;
import org.nightlabs.jfire.scripting.editor2d.ScriptRegistryTreeLabelProvider;
import org.nightlabs.jfire.scripting.editor2d.request.TextScriptCreateRequest;
...
extends CenteredDialog 
{
	...
	protected void configureShell(Shell newShell) 
	{
		...
		newShell.setText(Messages.getString("org.nightlabs.jfire.scripting.editor2d.dialog.CreateTextScriptDialog.title")); //$NON-NLS-1$
	...
	protected Control createDialogArea(Composite parent) 
	{
		...
		scriptGroup.setText(Messages.getString("org.nightlabs.jfire.scripting.editor2d.dialog.CreateTextScriptDialog.group.script")); //$NON-NLS-1$
		...
		textGroup.setText(Messages.getString("org.nightlabs.jfire.scripting.editor2d.dialog.CreateTextScriptDialog.group.text")); //$NON-NLS-1$
		Composite textComp = new XComposite(textGroup, SWT.NONE);		
		
		createEntry(textComp, Messages.getString("org.nightlabs.jfire.scripting.editor2d.dialog.CreateTextScriptDialog.label.font"), ENTRY_FONT); //$NON-NLS-1$
		createEntry(textComp, Messages.getString("org.nightlabs.jfire.scripting.editor2d.dialog.CreateTextScriptDialog.label.size"), ENTRY_SIZE); //$NON-NLS-1$
		createEntry(textComp, Messages.getString("org.nightlabs.jfire.scripting.editor2d.dialog.CreateTextScriptDialog.label.bold"), ENTRY_BOLD);		 //$NON-NLS-1$
		createEntry(textComp, Messages.getString("org.nightlabs.jfire.scripting.editor2d.dialog.CreateTextScriptDialog.label.italic"), ENTRY_ITALIC);				 //$NON-NLS-1$
		createEntry(textComp, Messages.getString("org.nightlabs.jfire.scripting.editor2d.dialog.CreateTextScriptDialog.label.rotation"), ENTRY_ROTATION);		 //$NON-NLS-1$
		createEntry(textComp, Messages.getString("org.nightlabs.jfire.scripting.editor2d.dialog.CreateTextScriptDialog.label.x"), ENTRY_X);		 //$NON-NLS-1$
		createEntry(textComp, Messages.getString("org.nightlabs.jfire.scripting.editor2d.dialog.CreateTextScriptDialog.label.y"), ENTRY_Y);		 //$NON-NLS-1$
...
//	private String defaultFontName = FontUtil.getDefaultFont().getName();
	...
	protected void initScriptTree() 
	{
		...
		tc.setText(Messages.getString("org.nightlabs.jfire.scripting.editor2d.dialog.CreateTextScriptDialog.treeColumn.name"));		 //$NON-NLS-1$
		tc = new TreeColumn(getScriptTree().getTree(), SWT.LEFT);
		tc.setText(Messages.getString("org.nightlabs.jfire.scripting.editor2d.dialog.CreateTextScriptDialog.treeColumn.value"));		 //$NON-NLS-1$
...
//		italicButton.addSelectionListener(italicListener);
  ...
  private SelectionListener fontListener = new SelectionListener()
	...
	private String text = Messages.getString("org.nightlabs.jfire.scripting.editor2d.dialog.CreateTextScriptDialog.text"); //$NON-NLS-1$
