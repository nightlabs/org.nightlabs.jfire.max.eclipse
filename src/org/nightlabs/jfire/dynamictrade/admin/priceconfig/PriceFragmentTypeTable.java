...
extends AbstractTableComposite
{
	...
	protected void createTableColumns(TableViewer tableViewer, Table table)
	{
		...
		tc.setText(Messages.getString("org.nightlabs.jfire.dynamictrade.admin.priceconfig.PriceFragmentTypeTable.priceFragmentTypeTableColumn.text")); //$NON-NLS-1$

		tc = new TableColumn(table, SWT.CENTER);
		tc.setText(Messages.getString("org.nightlabs.jfire.dynamictrade.admin.priceconfig.PriceFragmentTypeTable.useAsInputTableColumn.text")); //$NON-NLS-1$
