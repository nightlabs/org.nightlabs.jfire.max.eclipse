...
import org.nightlabs.jfire.trade.admin.moneyflow.MoneyFlowConfigComposite;
...
extends ToolBarSectionPart
{
	...
	extends SelectionAction 
	{
		public AddDelegateAction() {
			...
			setToolTipText(Messages.getString("org.nightlabs.jfire.trade.admin.editor.ProductTypeMoneyFlowConfigSection.AddDelegateAction.toolTipText")); //$NON-NLS-1$
			setText(Messages.getString("org.nightlabs.jfire.trade.admin.editor.ProductTypeMoneyFlowConfigSection.AddDelegateAction.text")); //$NON-NLS-1$
		}
	...
	extends SelectionAction 
	{
		public RemoveDelegateAction() {
			...
			setToolTipText(Messages.getString("org.nightlabs.jfire.trade.admin.editor.ProductTypeMoneyFlowConfigSection.RemoveDelegateAction.toolTipText")); //$NON-NLS-1$
			setText(Messages.getString("org.nightlabs.jfire.trade.admin.editor.ProductTypeMoneyFlowConfigSection.RemoveDelegateAction.text")); //$NON-NLS-1$
		}
	...
	extends SelectionAction 
	{
		public AssignAction() {
			...
			setToolTipText(Messages.getString("org.nightlabs.jfire.trade.admin.editor.ProductTypeMoneyFlowConfigSection.AssignAction.toolTipText")); //$NON-NLS-1$
			setText(Messages.getString("org.nightlabs.jfire.trade.admin.editor.ProductTypeMoneyFlowConfigSection.AssignAction.text")); //$NON-NLS-1$
		}
