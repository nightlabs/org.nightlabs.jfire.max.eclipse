...
public class PriceFragmentTypeSelectionPage extends DynamicPathWizardPage
{
	...
	public PriceFragmentTypeSelectionPage() {
		super(PriceFragmentTypeSelectionPage.class.getName(), Messages.getString("org.nightlabs.jfire.trade.accounting.PriceFragmentTypeSelectionPage.title")); //$NON-NLS-1$
		setDescription(Messages.getString("org.nightlabs.jfire.trade.accounting.PriceFragmentTypeSelectionPage.description")); //$NON-NLS-1$
	}
