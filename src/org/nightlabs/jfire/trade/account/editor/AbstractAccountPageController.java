...
extends EntityEditorPageController 
{
	...
	private NotificationListener accountChangedListener = new NotificationAdapterJob(Messages.getString("org.nightlabs.jfire.trade.account.editor.AbstractAccountPageController.loadingChangedAccountJob.name")) //$NON-NLS-1$
	{
	...
	{
		monitor.beginTask(Messages.getString("org.nightlabs.jfire.trade.account.editor.AbstractAccountPageController.loadingAccountJob.name"), 4); //$NON-NLS-1$
		try {
			if (anchorID != null) {
