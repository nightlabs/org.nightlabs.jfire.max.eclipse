...
public class ReportingPlugin extends AbstractUIPlugin {
	...
	public static final String DEFAULT_REPORT_USE_CASE_ID = "org.nightlabs.jfire.reporting.defaultReportUseCase"; //$NON-NLS-1$
...
//	}
	...
	public static ImageDescriptor getImageDescriptor(String path) {
		return AbstractUIPlugin.imageDescriptorFromPlugin("org.nightlabs.jfire.reporting", path); //$NON-NLS-1$
	}
...
//	}
	...
	public static File createReportTempFolder() {
		...
		try {
			...
			cdt.tag("JFire.org - org.nightlabs.jfire.reporting", true, false); //$NON-NLS-1$
		} catch (Exception x) {
