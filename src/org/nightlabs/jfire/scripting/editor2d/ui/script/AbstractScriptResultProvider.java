...
implements IScriptResultProvider<T> 
{
	...
	public void addScriptResultsChangedListener(IScriptResultChangedListener listener) {
		getListenerList().add(listener);
	}

	public void removeScriptResultChangedListener(IScriptResultChangedListener listener) {
