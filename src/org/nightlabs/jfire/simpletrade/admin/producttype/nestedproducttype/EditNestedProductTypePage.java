		...
		extends DynamicPathWizardPage
{
	...
	{
		super(EditNestedProductTypePage.class.getName(), Messages.getString("org.nightlabs.jfire.simpletrade.admin.producttype.nestedproducttype.EditNestedProductTypePage.title"), null); //$NON-NLS-1$
		setDescription(Messages.getString("org.nightlabs.jfire.simpletrade.admin.producttype.nestedproducttype.EditNestedProductTypePage.description")); //$NON-NLS-1$
	...
	public Control createPageContents(Composite parent)
	{
		...
		new Label(page, SWT.NONE).setText(Messages.getString("org.nightlabs.jfire.simpletrade.admin.producttype.nestedproducttype.EditNestedProductTypePage.quantityLabel.text")); //$NON-NLS-1$
