...
package org.nightlabs.jfire.reporting.admin.oda.jdoql.client;
...
public class ClientJDOQLProxyFactory implements IJDOQueryProxyFactory {
	...
	/* (non-Javadoc)
	 * @see org.nightlabs.jfire.reporting.admin.oda.jdo.IJDOQueryProxyFactory#createJDOQueryProxy(java.util.Map)
	 */
