...
package org.nightlabs.jfire.trade.admin.gridpriceconfig.addtariff;
...
public class TariffSelectionPage extends DynamicPathWizardPage
{
	...
	{
		super(TariffSelectionPage.class.getName(), Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.addtariff.TariffSelectionPage.title")); //$NON-NLS-1$
	}
	...
	public Control createPageContents(Composite parent)
	{
		...
		createNewTariffRadio.setText(Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.addtariff.TariffSelectionPage.createNewTariffRadio.text")); //$NON-NLS-1$
		...
		chooseExistingTariffRadio.setText(Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.addtariff.TariffSelectionPage.chooseExistingTariffRadio.text")); //$NON-NLS-1$
		...
		tariffList.add(Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.addtariff.TariffSelectionPage.pseudoEntry_loading")); //$NON-NLS-1$
		Job loadJob = new Job(Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.addtariff.TariffSelectionPage.loadTariffsJob.name")) { //$NON-NLS-1$
			@Override
