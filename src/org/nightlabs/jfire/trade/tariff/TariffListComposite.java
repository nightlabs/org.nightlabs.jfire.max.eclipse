package org.nightlabs.jfire.trade.tariff;
...
implements ISelectionProvider
{
	...
	public void loadTariffs()
	{
		...
		tariffList.add(Messages.getString("org.nightlabs.jfire.trade.tariff.TariffListComposite.pseudoEntry_loading")); //$NON-NLS-1$

		new Job(Messages.getString("org.nightlabs.jfire.trade.tariff.TariffListComposite.loadTariffsJob.name")) { //$NON-NLS-1$
			@Override
