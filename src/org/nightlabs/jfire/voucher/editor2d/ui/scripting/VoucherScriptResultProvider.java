...
//		getScriptResults(Collections.emptySet(), null, new NullProgressMonitor());
	...
	protected Map<ProductID, Map<ScriptRegistryItemID, Object>> getVoucherScriptingResult(
			PreviewParameterSet previewParameterSet, IProgressMonitor monitor)
	{
		try {
			...
			Map<ProductID, Map<ScriptRegistryItemID, Object>> result = vm.getPreviewVoucherData(previewParameterSet);
			monitor.worked(1);
			return result;
		} catch (Exception e) {
