...
extends AbstractTableComposite<ArticleContainer>
{
	...
	protected void createTableColumns(TableViewer tableViewer, Table table) 
	{
		...
		c.setText(Messages.getString("org.nightlabs.jfire.trade.overview.AbstractArticleContainerListComposite.organisationIDTableColumn.text")); //$NON-NLS-1$
		...
		c = new TableColumn(table, SWT.LEFT);
		c.setText(Messages.getString("org.nightlabs.jfire.trade.overview.AbstractArticleContainerListComposite.customerTableColumn.text")); //$NON-NLS-1$
		tableLayout.addColumnData(new ColumnWeightData(10));

		c = new TableColumn(table, SWT.LEFT);
		c.setText(Messages.getString("org.nightlabs.jfire.trade.overview.AbstractArticleContainerListComposite.vendorTableColumn.text")); //$NON-NLS-1$
		tableLayout.addColumnData(new ColumnWeightData(10));

		c = new TableColumn(table, SWT.LEFT);
		c.setText(Messages.getString("org.nightlabs.jfire.trade.overview.AbstractArticleContainerListComposite.createDateTableColumn.text")); //$NON-NLS-1$
		tableLayout.addColumnData(new ColumnWeightData(10));

		c = new TableColumn(table, SWT.LEFT);
		c.setText(Messages.getString("org.nightlabs.jfire.trade.overview.AbstractArticleContainerListComposite.createUserTableColumn.text")); //$NON-NLS-1$
		tableLayout.addColumnData(new ColumnWeightData(10));

		c = new TableColumn(table, SWT.LEFT);
		c.setText(Messages.getString("org.nightlabs.jfire.trade.overview.AbstractArticleContainerListComposite.amountTableColumn.text")); //$NON-NLS-1$
		tableLayout.addColumnData(new ColumnWeightData(10));

		if (Statable.class.isAssignableFrom(getArticleContainerClass())) {
			c = new TableColumn(table, SWT.LEFT);
			c.setText(Messages.getString("org.nightlabs.jfire.trade.overview.AbstractArticleContainerListComposite.currentStateTableColumn.text")); //$NON-NLS-1$
			tableLayout.addColumnData(new ColumnWeightData(10));
		}
