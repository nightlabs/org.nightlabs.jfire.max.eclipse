...
extends EntityEditorPageWithProgress
{
	...
	public RepositoryGeneralPage(FormEditor editor) {
		super(editor, RepositoryGeneralPage.class.getName(), Messages.getString("org.nightlabs.jfire.trade.ui.repository.editor.RepositoryGeneralPage.title")); //$NON-NLS-1$
	}
	...
	protected String getPageFormTitle() {
		return Messages.getString("org.nightlabs.jfire.trade.ui.repository.editor.RepositoryGeneralPage.title"); //$NON-NLS-1$
	}
