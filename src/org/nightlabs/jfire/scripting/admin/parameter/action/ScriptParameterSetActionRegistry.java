...
public class ScriptParameterSetActionRegistry extends AbstractActionRegistry {
	...
	public static final String EXTENSION_POINT_ID = "org.nightlabs.jfire.scripting.admin.scriptParameterSetAction";
	...
	protected Object createActionOrContributionItem(IExtension extension,
		...
		try {
			...
			throw new IllegalArgumentException("The class specified for registryItemAction with id "+element.getAttribute(ATTRIBUTE_NAME_ACTION_ID)+" does not implement "+IScriptParameterSetAction.class.getName()+". It was set to "+className+".");
	...
	{
		return "scriptParameterSetAction";
	}
