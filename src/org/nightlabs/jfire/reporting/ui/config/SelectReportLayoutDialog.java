...
import org.nightlabs.jfire.reporting.ui.layout.ReportRegistryItemTable;
import org.nightlabs.jfire.reporting.ui.resource.Messages;

/**
 * A dialog that lets the user choose a {@link ReportLayout}
			...
			public void selectionChanged(SelectionChangedEvent event) {
				...
				if (item != null) {
					if (item.getDescription().isEmpty()) {
						descriptionText.setText(Messages.getString("org.nightlabs.jfire.reporting.ui.config.SelectReportLayoutDialog.descriptionText.text")); //$NON-NLS-1$
					} else {
