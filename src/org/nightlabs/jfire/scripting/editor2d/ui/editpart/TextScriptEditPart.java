...
import org.nightlabs.jfire.scripting.editor2d.ui.model.TextScriptPropertySource;
...
extends TextEditPart 
{
	 ...
	 * @param text
	 */
	public TextScriptEditPart(TextScriptDrawComponent text) {
		super(text);
	}

	public TextScriptDrawComponent getTextScriptDrawComponent() {
