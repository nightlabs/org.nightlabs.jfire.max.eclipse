		...
		implements ProductTypeSelector, ISelectionProvider
{
	...
	public ProductTypeSelectorListImpl(Composite parent, int style)
	{
		...
		productLabel.setText(Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.ProductTypeSelectorListImpl.productTypeLabel.text")); //$NON-NLS-1$
	...
	public void setPackageProductType(ProductType packageProductType)
	{
		...
		if (packageProductType != null) {
			...
			if (packageProductType.getInnerPriceConfig() != null) {
				...
				productTypeGUIList.add(packageProductType.getName().getText(languageID) + Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.ProductTypeSelectorListImpl.packageProductType_base")); //$NON-NLS-1$
			}
...
//					continue;
			...
			if (packageProductType.getPackagePriceConfig() != null) {
				...
				productTypeGUIList.add(packageProductType.getName().getText(languageID) + Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.ProductTypeSelectorListImpl.packageProductType_total")); //$NON-NLS-1$
			}
