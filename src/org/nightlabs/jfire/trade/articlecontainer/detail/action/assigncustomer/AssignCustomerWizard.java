		...
		extends LegalEntitySearchCreateWizard
{
	...
	{
		super(Messages.getString("org.nightlabs.jfire.trade.articlecontainer.detail.action.assigncustomer.AssignCustomerWizard.quickSearchText"), true); //$NON-NLS-1$
	...
	public boolean performFinish()
	{
		...
		try {
			...
			RCPUtil.openEditor(input, GeneralEditor.ID_EDITOR);
