...
//		}
		...
		publishedCheckBox.setText(Messages.getString("org.nightlabs.jfire.trade.admin.producttype.SaleAccessControlComposite.publishedCheckBox.text")); //$NON-NLS-1$
		...
		confirmedCheckBox.setText(Messages.getString("org.nightlabs.jfire.trade.admin.producttype.SaleAccessControlComposite.confirmedCheckBox.text")); //$NON-NLS-1$
		...
		saleableCheckBox.setText(Messages.getString("org.nightlabs.jfire.trade.admin.producttype.SaleAccessControlComposite.saleableCheckBox.text")); //$NON-NLS-1$
		...
		closedCheckBox.setText(Messages.getString("org.nightlabs.jfire.trade.admin.producttype.SaleAccessControlComposite.closedCheckBox.text")); //$NON-NLS-1$
			...
			if (publishedCheckBox.getSelection()) {
				...
				if (flag) {
					flag = MessageDialog.openConfirm(
							...
							Messages.getString("org.nightlabs.jfire.trade.admin.producttype.SaleAccessControlComposite.publishDialog.title"), //$NON-NLS-1$
							Messages.getString("org.nightlabs.jfire.trade.admin.producttype.SaleAccessControlComposite.publishDialog.message")); //$NON-NLS-1$
				}
				...
				if (productType.isPublished()) {
					MessageDialog.openError(
							RCPUtil.getActiveWorkbenchShell(),
							Messages.getString("org.nightlabs.jfire.trade.admin.producttype.SaleAccessControlComposite.publishDialog.undo.title"), //$NON-NLS-1$
							Messages.getString("org.nightlabs.jfire.trade.admin.producttype.SaleAccessControlComposite.publishDialog.undo.message")); //$NON-NLS-1$
		...
		try {
			if (confirmedCheckBox.getSelection()) {
				...
				if (flag) {
					flag = MessageDialog.openConfirm(
							RCPUtil.getActiveWorkbenchShell(),
							Messages.getString("org.nightlabs.jfire.trade.admin.producttype.SaleAccessControlComposite.confirmDialog.title"), //$NON-NLS-1$
							Messages.getString("org.nightlabs.jfire.trade.admin.producttype.SaleAccessControlComposite.confirmDialog.message")); //$NON-NLS-1$
				}
				...
				if (productType.isConfirmed()) {
					MessageDialog.openError(
							RCPUtil.getActiveWorkbenchShell(),
							Messages.getString("org.nightlabs.jfire.trade.admin.producttype.SaleAccessControlComposite.undoConfirmDialog.title"), //$NON-NLS-1$
							Messages.getString("org.nightlabs.jfire.trade.admin.producttype.SaleAccessControlComposite.undoConfirmDialog.message")); //$NON-NLS-1$
		...
		try {
			if (closedCheckBox.getSelection()) {
				...
				if (flag) {
					flag = MessageDialog.openConfirm(
							RCPUtil.getActiveWorkbenchShell(),
							Messages.getString("org.nightlabs.jfire.trade.admin.producttype.SaleAccessControlComposite.closeDialog.title"), //$NON-NLS-1$
							Messages.getString("org.nightlabs.jfire.trade.admin.producttype.SaleAccessControlComposite.closeDialog.message"));					 //$NON-NLS-1$
				}
	...
	protected NotificationListener productTypeChangedListener = new NotificationAdapterJob(Messages.getString("org.nightlabs.jfire.trade.admin.producttype.SaleAccessControlComposite.loadProductTypesJob.name")) { //$NON-NLS-1$
...
//		ProductType.FETCH_GROUP_NAME};
	...
	public void setProductType(ProductType productType)
	{
		...
		if (productType == null) {
			setEnabled(false);
			if (showProductTypeLabel)
				productTypeLabel.setText(Messages.getString("org.nightlabs.jfire.trade.admin.producttype.SaleAccessControlComposite.productTypeLabel.text_nothingSelected")); //$NON-NLS-1$
			publishedCheckBox.setSelection(false);
			confirmedCheckBox.setSelection(false);
			saleableCheckBox.setSelection(false);
			closedCheckBox.setSelection(false);
