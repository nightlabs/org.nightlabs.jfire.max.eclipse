...
extends AbstractArticleContainerListComposite
{
			...
			TableViewer tableViewer, Table table, TableLayout tableLayout)
	{
		...
		tc.setText(Messages.getString("org.nightlabs.jfire.trade.overview.offer.OfferListComposite.offerIDPrefixTableColumn.text")); //$NON-NLS-1$
			...
			Table table, TableLayout tableLayout)
	{
		...
		tc.setText(Messages.getString("org.nightlabs.jfire.trade.overview.offer.OfferListComposite.offerIDTableColumn.text")); //$NON-NLS-1$
		tableLayout.addColumnData(new ColumnWeightData(10));
	}
	...
	{
		TableColumn tc = new TableColumn(table, SWT.LEFT);
		tc.setText(Messages.getString("org.nightlabs.jfire.trade.overview.offer.OfferListComposite.finalizeDateTableColumn.text")); //$NON-NLS-1$
		tableLayout.addColumnData(new ColumnWeightData(10));
		
		tc = new TableColumn(table, SWT.LEFT);
		tc.setText(Messages.getString("org.nightlabs.jfire.trade.overview.offer.OfferListComposite.finalizeUserTableColumn.text")); //$NON-NLS-1$
		tableLayout.addColumnData(new ColumnWeightData(10));

		tc = new TableColumn(table, SWT.LEFT);
		tc.setText(Messages.getString("org.nightlabs.jfire.trade.overview.offer.OfferListComposite.priceTableColumn.text")); //$NON-NLS-1$
		tableLayout.addColumnData(new ColumnWeightData(10));
	}
