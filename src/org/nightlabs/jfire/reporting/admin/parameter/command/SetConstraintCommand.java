...
//	private Dimension oldSize;
	...
	public SetConstraintCommand() {
		super();
		setLabel(Messages.getString("org.nightlabs.jfire.reporting.admin.parameter.command.SetConstraintCommand.changeBounds.label")); //$NON-NLS-1$
	}
...
//		if (oldSize.equals(newSize))
			return Messages.getString("org.nightlabs.jfire.reporting.admin.parameter.command.SetConstraintCommand.changeLocation.label"); //$NON-NLS-1$
//		return "Resize";
	}
