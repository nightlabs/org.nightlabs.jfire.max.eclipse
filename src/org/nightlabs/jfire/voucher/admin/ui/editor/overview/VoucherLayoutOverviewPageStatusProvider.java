...
extends AbstractProductTypeOverviewPageStatusProvider 
{
	...
	protected IStatus createStatus(ProductType productType) 
	{
		if (productType != null && productType instanceof VoucherType) {
			...
			sb.append(Messages.getString("org.nightlabs.jfire.voucher.admin.ui.editor.overview.VoucherLayoutOverviewPageStatusProvider.label.voucherLayout")); //$NON-NLS-1$
			String name = Messages.getString("org.nightlabs.jfire.voucher.admin.ui.editor.overview.VoucherLayoutOverviewPageStatusProvider.label.none"); //$NON-NLS-1$
