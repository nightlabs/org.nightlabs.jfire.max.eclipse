...
//	}
	...
	public ProductTypeMoneyFlowConfigPage(FormEditor editor) {
		super(editor, ProductTypeMoneyFlowConfigPage.class.getName(), 
				Messages.getString("org.nightlabs.jfire.trade.admin.editor.ProductTypeMoneyFlowConfigPage.title")); //$NON-NLS-1$
	}
	...
	protected void addSections(Composite parent) {
		moneyFlowSection = new ProductTypeMoneyFlowConfigSection(this, parent, 
				...
				Messages.getString("org.nightlabs.jfire.trade.admin.editor.ProductTypeMoneyFlowConfigPage.moneyFlowSection.title")); //$NON-NLS-1$
...
//				moneyFlowSection.setProductTypeID(controller.getProductTypeID());
				...
				if (controller.getProductType() != null && controller.getProductType().isClosed()) {
					moneyFlowSection.setMessage(Messages.getString("org.nightlabs.jfire.trade.admin.editor.ProductTypeMoneyFlowConfigPage.moneyFlowSectionMessage_productTypeClosed")); //$NON-NLS-1$
	...
	protected String getPageFormTitle() {
		return Messages.getString("org.nightlabs.jfire.trade.admin.editor.ProductTypeMoneyFlowConfigPage.pageFormTitle"); //$NON-NLS-1$
	}
