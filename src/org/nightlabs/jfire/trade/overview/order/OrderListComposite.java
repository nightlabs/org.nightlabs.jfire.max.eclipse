...
extends AbstractArticleContainerListComposite 
{
			...
			TableViewer tableViewer, Table table, TableLayout tableLayout)
	{
		...
		tc.setText(Messages.getString("org.nightlabs.jfire.trade.overview.order.OrderListComposite.orderIDPrefixTableColumn.text")); //$NON-NLS-1$
			...
			Table table, TableLayout tableLayout)
	{
		...
		tc.setText(Messages.getString("org.nightlabs.jfire.trade.overview.order.OrderListComposite.orderIDTableColumn.text")); //$NON-NLS-1$
		tableLayout.addColumnData(new ColumnWeightData(10));
	}
	...
	{
		TableColumn tc = new TableColumn(table, SWT.RIGHT);
		tc.setText(Messages.getString("org.nightlabs.jfire.trade.overview.order.OrderListComposite.changeDateTableColumn.text")); //$NON-NLS-1$
		tableLayout.addColumnData(new ColumnWeightData(10));

		tc = new TableColumn(table, SWT.RIGHT);
		tc.setText(Messages.getString("org.nightlabs.jfire.trade.overview.order.OrderListComposite.changeUserTableColumn.text")); //$NON-NLS-1$
		tableLayout.addColumnData(new ColumnWeightData(10));
	}
