package org.nightlabs.jfire.reporting.admin.parameter.dialog;
...
extends CenteredDialog 
{
	...
	public void create() 
	{
		super.create();
		if (mode == EDIT_MODE)
			getShell().setText(Messages.getString("org.nightlabs.jfire.reporting.admin.parameter.dialog.UseCaseDialog.editMode.shell.text")); //$NON-NLS-1$
		if (mode == NEW_MODE)
			getShell().setText(Messages.getString("org.nightlabs.jfire.reporting.admin.parameter.dialog.UseCaseDialog.newMode.shell.text"));		 //$NON-NLS-1$
	...
	protected Control createDialogArea(Composite parent) 
	{
		...
		nameEditor = new I18nTextEditor(wrapper, Messages.getString("org.nightlabs.jfire.reporting.admin.parameter.dialog.UseCaseDialog.nameEditor.caption")); //$NON-NLS-1$
//		nameEditor.setEditMode(EditMode.BUFFERED);
		if (useCase != null)
			nameEditor.setI18nText(useCase.getName(), EditMode.BUFFERED);
		descriptionEditor = new I18nTextEditor(wrapper, Messages.getString("org.nightlabs.jfire.reporting.admin.parameter.dialog.UseCaseDialog.descriptionEditor.caption")); //$NON-NLS-1$
