...
import org.nightlabs.jfire.trade.transfer.deliver.ClientDeliveryProcessorFactory;
import org.nightlabs.jfire.trade.transfer.deliver.ClientDeliveryProcessorFactoryRegistry;
 ...
 * {@link org.nightlabs.jfire.trade.transfer.deliver.ClientDeliveryProcessor}s are appended
...
//	private DeliveryWizardHop wizardHop;
	...
	{
		super(DeliveryEntryPage.class.getName() + '/' + delivery.getDeliveryID(), Messages.getString("org.nightlabs.jfire.trade.transfer.wizard.DeliveryEntryPage.title"), //$NON-NLS-1$
				SharedImages.getSharedImageDescriptor(TradePlugin.getDefault(), DeliveryEntryPage.class, null, ImageDimension._75x70));
		setMessage(null);
		setDescription(
				Messages.getString("org.nightlabs.jfire.trade.transfer.wizard.DeliveryEntryPage.description")); //$NON-NLS-1$
...
//		super(DeliveryEntryPage.class.getName() + '/' + deliveryList.get(0).getDeliveryID(), Messages.getString("org.nightlabs.jfire.trade.transfer.wizard.DeliveryEntryPage.title"), //$NON-NLS-1$
//				SharedImages.getSharedImageDescriptor(TradePlugin.getDefault(), DeliveryEntryPage.class, null, ImageDimension._75x70));
//
//		setMessage(null);
//		setDescription(
...
// end test
		...
		new Label(page, SWT.NONE).setText(Messages.getString("org.nightlabs.jfire.trade.transfer.wizard.DeliveryEntryPage.productTypesLabel.text")); //$NON-NLS-1$
		...
		new Label(page, SWT.NONE).setText(Messages.getString("org.nightlabs.jfire.trade.transfer.wizard.DeliveryEntryPage.modeOfDeliveryFlavourLabel.text")); //$NON-NLS-1$
...
//			modeOfDeliveryFlavourGUIList.select(0);
		...
		spacer.getGridData().grabExcessVerticalSpace = false;
		spacer.getGridData().heightHint = 4;
		(clientDeliveryProcessorFactoryLabel = new Label(page, SWT.NONE)).setText(Messages.getString("org.nightlabs.jfire.trade.transfer.wizard.DeliveryEntryPage.clientDeliveryProcessorFactoryLabel.text")); //$NON-NLS-1$
		...
		spacer.getGridData().grabExcessVerticalSpace = false;
		spacer.getGridData().heightHint = 4;
		(serverDeliveryProcessorLabel = new Label(page, SWT.NONE)).setText(Messages.getString("org.nightlabs.jfire.trade.transfer.wizard.DeliveryEntryPage.serverDeliveryProcessorLabel.text")); //$NON-NLS-1$
...
//			selectedModeOfDeliveryFlavour = (ModeOfDeliveryFlavour) modeOfDeliveryFlavours.get(idx);
			...
			if (clientDeliveryProcessorFactoryCombo.getItemCount() > 0)
				...
				setMessage(String.format(
						Messages.getString("org.nightlabs.jfire.trade.transfer.wizard.DeliveryEntryPage.errorNoClientDeliveryProcessorFactoryRegisteredForSelectedModeOfDeliveryFlavour"), //$NON-NLS-1$
...
//		wizard.removeAllDynamicWizardPages();
		...
		if (idx >= 0) {
			...
			if (serverDeliveryProcessorCombo.getItemCount() > 0)
				...
				setMessage(String.format(
						Messages.getString("org.nightlabs.jfire.trade.transfer.wizard.DeliveryEntryPage.errorNoServerDeliveryProcessorRegisteredForSelectedModeOfDeliveryFlavour"), //$NON-NLS-1$
						selectedModeOfDeliveryFlavour.getPrimaryKey(),
						selectedModeOfDeliveryFlavour.getName().getText()), IMessageProvider.ERROR);
		}
