...
{	
	...
	public String getTitle()
	{
		...
		Job loadTitleJob = new Job(Messages.getString("org.nightlabs.jfire.trade.admin.editor.AbstractProductTypeAdminEditor.loadTitleJob.name")) { //$NON-NLS-1$
			@Override
	...
	public void init(IEditorSite site, IEditorInput input) throws PartInitException {
		...
		EditLockMan.sharedInstance().acquireEditLockAsynchronously(
				...
				Messages.getString("org.nightlabs.jfire.trade.admin.editor.AbstractProductTypeAdminEditor.editLock.description"), (EditLockCallback) null //$NON-NLS-1$
				);
	}
