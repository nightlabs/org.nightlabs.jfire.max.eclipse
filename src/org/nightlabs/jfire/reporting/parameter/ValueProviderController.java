...
extends ActiveJDOObjectTreeController<ObjectID, Object, ValueProviderTreeNode> 
{
	...
	protected void createRegisterChangeListener() {
		if (changeListener == null) {
			changeListener = new ChangeListener(Messages.getString("org.nightlabs.jfire.reporting.parameter.ValueProviderController.registerChangeListener.name")); //$NON-NLS-1$
