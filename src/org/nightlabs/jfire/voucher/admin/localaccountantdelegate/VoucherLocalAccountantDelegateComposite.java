package org.nightlabs.jfire.voucher.admin.localaccountantdelegate;
		...
		public String getColumnText(Object element, int columnIndex)
		{
			if (element instanceof Map.Entry) {
				...
				switch (columnIndex) {
					...
					case 1:
						return me.getValue() == null ? Messages.getString("org.nightlabs.jfire.voucher.admin.localaccountantdelegate.VoucherLocalAccountantDelegateComposite.VoucherLocalAccountantDelegateLabelProvider.accountName_noneAssigned") : me.getValue().getName().getText(); //$NON-NLS-1$
					default:
						return ""; //$NON-NLS-1$
				}
			}
...
//				}
	...
	public VoucherLocalAccountantDelegateComposite(Composite parent, boolean showButtons)
	{
		...
		new TableColumn(table, SWT.LEFT).setText(Messages.getString("org.nightlabs.jfire.voucher.admin.localaccountantdelegate.VoucherLocalAccountantDelegateComposite.currencyTableColumn.text")); //$NON-NLS-1$
		new TableColumn(table, SWT.LEFT).setText(Messages.getString("org.nightlabs.jfire.voucher.admin.localaccountantdelegate.VoucherLocalAccountantDelegateComposite.accountTableColumn.text")); //$NON-NLS-1$
		...
		if (showButtons) {
			...
			addCurrencyButton.setText(Messages.getString("org.nightlabs.jfire.voucher.admin.localaccountantdelegate.VoucherLocalAccountantDelegateComposite.addCurrencyButton.text")); //$NON-NLS-1$
			...
			removeCurrencyButton.setText(Messages.getString("org.nightlabs.jfire.voucher.admin.localaccountantdelegate.VoucherLocalAccountantDelegateComposite.removeCurrencyButton.text")); //$NON-NLS-1$
