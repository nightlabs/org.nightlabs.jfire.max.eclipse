...
public class EditUseCaseConfigComposite extends XComposite {
	...
	protected void initGUI() {
		...
		viewFormatLabel.setText(Messages.getString("org.nightlabs.jfire.reporting.config.EditUseCaseConfigComposite.viewFormatLabel.text")); //$NON-NLS-1$
		viewFormatCombo = new BirtOutputCombo(this, SWT.READ_ONLY);		
		Label reportViewerLabel = new Label(this, SWT.WRAP);
		reportViewerLabel.setText(Messages.getString("org.nightlabs.jfire.reporting.config.EditUseCaseConfigComposite.reportViewerLabel.text")); //$NON-NLS-1$
		...
		printFormatLabel.setText(Messages.getString("org.nightlabs.jfire.reporting.config.EditUseCaseConfigComposite.printFormatLabel.text")); //$NON-NLS-1$
