...
public class ReportRegistryItemTable extends AbstractTableComposite<ReportRegistryItem> {
	...
	protected void createTableColumns(TableViewer tableViewer, Table table) {
		...
		col.setText(Messages.getString("org.nightlabs.jfire.reporting.layout.ReportRegistryItemTable.reportRegistryItemNameColumn.text")); //$NON-NLS-1$
	...
	public void setReportRegistryItemIDs(
		...
		Display.getDefault().asyncExec(new Runnable() {
			public void run() {
				setInput(Messages.getString("org.nightlabs.jfire.reporting.layout.ReportRegistryItemTable.loadingText")); //$NON-NLS-1$
			}
		});
		Job loadJob = new Job(Messages.getString("org.nightlabs.jfire.reporting.layout.ReportRegistryItemTable.loadReportRegistryItemsJob.name")) { //$NON-NLS-1$
			@Override
