...
//	protected abstract AbstractSaleAccessControlSection createSaleAccessControlSection();
			...
			public void run() {
				...
				if (productType.isClosed()) {
					getManagedForm().getForm().getForm().setMessage(
							Messages.getString("org.nightlabs.jfire.trade.admin.editor.AbstractProductTypeDetailPage.productTypeClosedMessage"),  //$NON-NLS-1$
	...
	protected String getPageFormTitle() {
		return Messages.getString("org.nightlabs.jfire.trade.admin.editor.AbstractProductTypeDetailPage.pageFormTitle"); //$NON-NLS-1$
	}
	...
	/**
	 * {@inheritDoc}
	 * @see org.nightlabs.jfire.trade.admin.editor.IProductTypeDetailPage#getProductTypeDetailPageController()
	 */
