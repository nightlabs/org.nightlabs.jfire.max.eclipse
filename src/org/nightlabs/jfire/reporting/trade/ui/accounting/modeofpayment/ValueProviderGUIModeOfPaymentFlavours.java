...
extends AbstractValueProviderGUI<Collection<ModeOfPaymentFlavourID>>
{
	...
	public Control createGUI(Composite wrapper) {
		...
		modeOfPaymentFlavourTable.setLoadingMessage(Messages.getString("org.nightlabs.jfire.reporting.trade.ui.accounting.modeofpayment.ValueProviderGUIModeOfPaymentFlavours.loadingMessage")); //$NON-NLS-1$
		Job job = new Job(Messages.getString("org.nightlabs.jfire.reporting.trade.ui.accounting.modeofpayment.ValueProviderGUIModeOfPaymentFlavours.jobName")) { //$NON-NLS-1$
			@Override
