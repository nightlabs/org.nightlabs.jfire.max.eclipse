...
import org.nightlabs.jfire.dynamictrade.admin.DynamicTradeAdminPlugin;
...
public class DynamicProductTypeNamePage extends DynamicPathWizardPage
{
	...
	public DynamicProductTypeNamePage(ProductTypeID parentDynamicProductTypeID)
	{
		super(DynamicProductTypeNamePage.class.getName(),
				Messages.getString("org.nightlabs.jfire.dynamictrade.admin.createproducttype.DynamicProductTypeNamePage.title"), //$NON-NLS-1$
				SharedImages.getWizardPageImageDescriptor(DynamicTradeAdminPlugin.getDefault(), DynamicProductTypeNamePage.class));
		this.setDescription(Messages.getString("org.nightlabs.jfire.dynamictrade.admin.createproducttype.DynamicProductTypeNamePage.description")); //$NON-NLS-1$
	...
	public Control createPageContents(Composite parent)
	{
		...
		inheritanceNatureCombo.add(Messages.getString("org.nightlabs.jfire.dynamictrade.admin.createproducttype.DynamicProductTypeNamePage.inheritanceNatureCombo.item_node")); //$NON-NLS-1$
		inheritanceNatureCombo.add(Messages.getString("org.nightlabs.jfire.dynamictrade.admin.createproducttype.DynamicProductTypeNamePage.inheritanceNatureCombo.item_leaf")); //$NON-NLS-1$
		...
		new Label(page, SWT.NONE).setText(Messages.getString("org.nightlabs.jfire.dynamictrade.admin.createproducttype.DynamicProductTypeNamePage.nameLabel.text")); //$NON-NLS-1$
