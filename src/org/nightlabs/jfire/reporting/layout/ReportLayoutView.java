...
public class ReportLayoutView extends ReportRegistryItemTreeView {
	...
	/* (non-Javadoc)
	 * @see org.nightlabs.jfire.reporting.layout.ReportRegistryItemTreeView#getActionScope()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.nightlabs.jfire.reporting.layout.ReportRegistryItemTreeView#getNotificationZone()
	 */
	@Override
