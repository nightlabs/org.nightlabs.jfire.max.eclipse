...
public class ManualMoneyTransferComposite extends XComposite {
	...
	public ManualMoneyTransferComposite(Composite parent, int style) {
		...
		amountLabel
		.setText(Messages
				.getString("org.nightlabs.jfire.trade.account.transfer.manual.ManualMoneyTransferComposite.amountLabel.text")); //$NON-NLS-1$
		...
		reasonLabel
		.setText(Messages
				.getString("org.nightlabs.jfire.trade.account.transfer.manual.ManualMoneyTransferComposite.reasonLabel.text")); //$NON-NLS-1$
		...
		lg
		.setText(Messages
				.getString("org.nightlabs.jfire.trade.account.transfer.manual.ManualMoneyTransferComposite.sourceAccountGroup.text")); //$NON-NLS-1$
		gridData = new GridData(GridData.FILL_BOTH);
		gridData.grabExcessVerticalSpace = true;
		...
		fAccountIDLabel
		.setText(Messages
				.getString("org.nightlabs.jfire.trade.account.transfer.manual.ManualMoneyTransferComposite.sourceAccountIDLabel.text")); //$NON-NLS-1$
		...
		fAccountNameLabel
		.setText(Messages
				.getString("org.nightlabs.jfire.trade.account.transfer.manual.ManualMoneyTransferComposite.sourceAccountNameLabel.text")); //$NON-NLS-1$
		...
		fBalanceLabel
		.setText(Messages
				.getString("org.nightlabs.jfire.trade.account.transfer.manual.ManualMoneyTransferComposite.sourceAccountBalanceLabel.text")); //$NON-NLS-1$
		...
		fOrganizationLabel
		.setText(Messages
				.getString("org.nightlabs.jfire.trade.account.transfer.manual.ManualMoneyTransferComposite.sourceAccountOrganisationLabel.text")); //$NON-NLS-1$
		...
		rg
		.setText(Messages
				.getString("org.nightlabs.jfire.trade.account.transfer.manual.ManualMoneyTransferComposite.targetAccountGroup.text")); //$NON-NLS-1$
		...
		tAccountIDLabel
		.setText(Messages
				.getString("org.nightlabs.jfire.trade.account.transfer.manual.ManualMoneyTransferComposite.targetAccountIDLabel.text")); //$NON-NLS-1$
		...
		tAccountNameLabel
		.setText(Messages
				.getString("org.nightlabs.jfire.trade.account.transfer.manual.ManualMoneyTransferComposite.targetAccountNameLabel.text")); //$NON-NLS-1$
		...
		tBalanceLabel
		.setText(Messages
				.getString("org.nightlabs.jfire.trade.account.transfer.manual.ManualMoneyTransferComposite.targetAccountBalanceLabel.text")); //$NON-NLS-1$
		...
		tOrganizationLabel
		.setText(Messages
				.getString("org.nightlabs.jfire.trade.account.transfer.manual.ManualMoneyTransferComposite.targetAccountOrganisationLabel.text")); //$NON-NLS-1$
