...
package org.nightlabs.jfire.trade.admin.gridpriceconfig.addcustomergroup;
...
public class CustomerGroupSelectionPage extends DynamicPathWizardPage
{
	...
	{
		super(CustomerGroupSelectionPage.class.getName(), Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.addcustomergroup.CustomerGroupSelectionPage.title")); //$NON-NLS-1$
		setDescription(Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.addcustomergroup.CustomerGroupSelectionPage.description")); //$NON-NLS-1$
	}
	...
	public Control createPageContents(Composite parent)
	{
		...
		createNewCustomerGroupRadio.setText(Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.addcustomergroup.CustomerGroupSelectionPage.createNewCustomerGroupRadio.text")); //$NON-NLS-1$
		...
		chooseExistingCustomerGroupRadio.setText(Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.addcustomergroup.CustomerGroupSelectionPage.chooseExistingCustomerGroupRadio.text")); //$NON-NLS-1$
		...
		customerGroupList.add(Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.addcustomergroup.CustomerGroupSelectionPage.pseudoEntry_loading")); //$NON-NLS-1$
		Job loadJob = new Job(Messages.getString("org.nightlabs.jfire.trade.admin.gridpriceconfig.addcustomergroup.CustomerGroupSelectionPage.loadCustomerGroupsJob.name")) { //$NON-NLS-1$
			@Override
